...
var _sfc_main = /*@__PURE__*/ Object.assign({ layout: AdminLayout_default }, {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-5b5a7528>`);
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("settings.create")) _push(`<button class="ui-btn ui-btn--primary" data-v-5b5a7528${_scopeId}>+ Add Settings</button>`);
						else _push(`<!---->`);
			...
			_push(ssrRenderComponent(DataTable_default, {
				...
				"cell:logo": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="settings-logo-cell" data-v-5b5a7528${_scopeId}>`);
						if (logoSrc(row.logo)) _push(`<img${ssrRenderAttr("src", logoSrc(row.logo))}${ssrRenderAttr("alt", `${row.company || row.name || "Company"} logo`)} class="settings-logo-cell__image" data-v-5b5a7528${_scopeId}>`);
						else _push(`<span class="settings-logo-cell__fallback" data-v-5b5a7528${_scopeId}>${ssrInterpolate(logoInitial(row))}</span>`);
						_push(`</div>`);
				...
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("settings.update")) _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-5b5a7528${_scopeId}>Edit</button>`);
						else _push(`<!---->`);
						if (unref(can)("settings.delete")) _push(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-5b5a7528${_scopeId}>Delete</button>`);
						else _push(`<!---->`);
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-5b5a7528${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-5b5a7528${_scopeId}>${ssrInterpolate(unref(form).processing ? "Saving…" : "Save")}</button>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<div class="ui-field" data-v-5b5a7528${_scopeId}><label class="ui-label" data-v-5b5a7528${_scopeId}>Logo</label><input type="file" class="ui-input" accept="image/*" data-v-5b5a7528${_scopeId}>`);
						if (unref(form).errors.logo) _push(`<p class="ui-field__error" data-v-5b5a7528${_scopeId}>${ssrInterpolate(unref(form).errors.logo)}</p>`);
						else _push(`<!---->`);
						if (previewUrl.value) _push(`<div style="${ssrRenderStyle({ "margin-top": "10px" })}" data-v-5b5a7528${_scopeId}><img${ssrRenderAttr("src", previewUrl.value)} alt="Preview" style="${ssrRenderStyle({
							"max-width": "120px",
							"border-radius": "8px"
						})}" data-v-5b5a7528${_scopeId}></div>`);
						else if (existingLogo.value) _push(`<img${ssrRenderAttr("src", logoSrc(existingLogo.value))} alt="Logo" style="${ssrRenderStyle({
							"max-width": "120px",
							"margin-top": "10px",
							"border-radius": "8px"
						})}" data-v-5b5a7528${_scopeId}>`);
						else _push(`<!---->`);
						_push(`</div>`);
					} else return [
...
var Settings_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-5b5a7528"]]);
//#endregion
