...
import { computed, createTextVNode, createVNode, mergeProps, onBeforeUnmount, onMounted, reactive, ref, toDisplayString, unref, useSSRContext, watch, withCtx } from "vue";
...
var _sfc_main$2 = {
	...
	setup(__props) {
			...
			},
			{
				...
				items: [
					...
					},
					{
						...
						icon: icon.key,
						permission: "change-password.view"
					}
				]
			}
		];
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			}, "sidebar"])}" data-v-f8492592><div class="sidebar__brand" data-v-f8492592><div class="${ssrRenderClass([{ "sidebar__logo--image": logoUrl.value && !logoFailed.value }, "sidebar__logo"])}" data-v-f8492592>`);
			if (logoUrl.value && !logoFailed.value) _push(`<img${ssrRenderAttr("src", logoUrl.value)} alt="GrillVibes logo" data-v-f8492592>`);
			else _push(`<span data-v-f8492592>G</span>`);
			_push(`</div><span class="sidebar__brand-name" data-v-f8492592>${ssrInterpolate(unref(page).props.branding?.name ?? "GrillVibes")}</span></div><nav class="sidebar__nav" data-v-f8492592><!--[-->`);
			ssrRenderList(visibleGroups.value, (group) => {
				_push(`<!--[--><div class="sidebar__group-title" data-v-f8492592>${ssrInterpolate(group.title)}</div><!--[-->`);
				ssrRenderList(group.items, (item) => {
					_push(ssrRenderComponent(unref(Link), {
						...
						default: withCtx((_, _push, _parent, _scopeId) => {
							if (_push) _push(`<span class="sidebar__icon" data-v-f8492592${_scopeId}>${item.icon ?? ""}</span><span class="sidebar__label" data-v-f8492592${_scopeId}>${ssrInterpolate(item.label)}</span>`);
			...
			_push(`<!--]--></nav></aside>`);
			if (unref(state).mobileOpen) _push(`<div class="sidebar__backdrop" data-v-f8492592></div>`);
			else _push(`<!---->`);
			_push(`<!--]-->`);
		};
	}
...
var Sidebar_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main$2, [["__scopeId", "data-v-f8492592"]]);
//#endregion
...
var _sfc_main$1 = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<header${ssrRenderAttrs(mergeProps({ class: "topbar" }, _attrs))} data-v-87f4162a><div class="topbar__left" data-v-87f4162a><button class="topbar__toggle" type="button" aria-label="Toggle menu" data-v-87f4162a><svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" data-v-87f4162a><path d="M3 6h18M3 12h18M3 18h18" data-v-87f4162a></path></svg></button><h1 class="topbar__title" data-v-87f4162a>${ssrInterpolate(pageTitle.value)}</h1></div><div class="topbar__right" data-v-87f4162a>`);
			if (branches.value.length) {
				_push(`<div class="topbar__branch" data-v-87f4162a><button class="topbar__branch-btn" type="button" data-v-87f4162a><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-87f4162a><path d="M3 21h18M6 21V8l6-4 6 4v13M10 21v-5h4v5" data-v-87f4162a></path></svg><span class="topbar__branch-name" data-v-87f4162a>${ssrInterpolate(currentBranchName.value)}</span><svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" data-v-87f4162a><path d="m6 9 6 6 6-6" data-v-87f4162a></path></svg></button>`);
				if (branchMenuOpen.value) {
					_push(`<div class="topbar__menu topbar__menu--branch" data-v-87f4162a><!--[-->`);
					ssrRenderList(branches.value, (b) => {
						_push(`<button class="${ssrRenderClass([{ "topbar__branch-item--active": b.id === currentBranchId.value }, "topbar__menu-item topbar__branch-item"])}" type="button" data-v-87f4162a><span data-v-87f4162a>${ssrInterpolate(b.name)}</span>`);
						if (b.id === currentBranchId.value) _push(`<svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" data-v-87f4162a><path d="M20 6 9 17l-5-5" data-v-87f4162a></path></svg>`);
						else _push(`<!---->`);
						_push(`</button>`);
					});
					_push(`<!--]--></div>`);
			...
			_push(`<div class="topbar__user" data-v-87f4162a><button class="topbar__user-btn" type="button" data-v-87f4162a><span class="topbar__avatar" data-v-87f4162a>${ssrInterpolate(initials.value)}</span><span class="topbar__user-name" data-v-87f4162a>${ssrInterpolate(user.value.name)}</span><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" data-v-87f4162a><path d="m6 9 6 6 6-6" data-v-87f4162a></path></svg></button>`);
			if (menuOpen.value) {
				_push(`<div class="topbar__menu" data-v-87f4162a>`);
				_push(ssrRenderComponent(unref(Link), {
					href: "/profile",
				...
				_push(`<div class="topbar__menu-divider" data-v-87f4162a></div><button class="topbar__menu-item topbar__menu-item--danger" data-v-87f4162a>Logout</button></div>`);
			} else _push(`<!---->`);
...
var Topbar_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main$1, [["__scopeId", "data-v-87f4162a"]]);
//#endregion
