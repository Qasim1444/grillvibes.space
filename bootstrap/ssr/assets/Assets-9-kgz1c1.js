		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("maintenance.assets.create")) _push(`<button class="ui-btn ui-btn--primary" data-v-f3a0a671${_scopeId}>+ New Asset</button>`);
						else _push(`<!---->`);
			...
			_push(ssrRenderComponent(DataTable_default, {
				...
				"cell:name": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<strong data-v-f3a0a671${_scopeId}>${ssrInterpolate(row.name)}</strong><span class="am__code" data-v-f3a0a671${_scopeId}>${ssrInterpolate(row.asset_code)}</span>`);
						if (row.location) _push(`<span class="am__muted" data-v-f3a0a671${_scopeId}> · ${ssrInterpolate(row.location)}</span>`);
						else _push(`<!---->`);
					} else return [
				...
				"cell:warranty_expiry": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (row.warranty_expiry) {
							_push(`<span data-v-f3a0a671${_scopeId}>${ssrInterpolate(fmtDate(row.warranty_expiry))} `);
							if (row.is_warranty_expiring) _push(`<span class="ui-badge ui-badge--danger am__pill" data-v-f3a0a671${_scopeId}>Expiring</span>`);
							else _push(`<!---->`);
							_push(`</span>`);
						} else _push(`<span class="am__muted" data-v-f3a0a671${_scopeId}>—</span>`);
				...
				"cell:next_maintenance_date": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (row.next_maintenance_date) {
							_push(`<span data-v-f3a0a671${_scopeId}>${ssrInterpolate(fmtDate(row.next_maintenance_date))} `);
							if (row.is_maintenance_due) _push(`<span class="ui-badge ui-badge--warning am__pill" data-v-f3a0a671${_scopeId}>Due</span>`);
							else _push(`<!---->`);
							_push(`</span>`);
						} else _push(`<span class="am__muted" data-v-f3a0a671${_scopeId}>—</span>`);
				...
				"cell:status": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="${ssrRenderClass([statusClass(value), "ui-badge"])}" data-v-f3a0a671${_scopeId}>${ssrInterpolate(statusLabel(value))}</span>`);
				...
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("maintenance.assets.update")) _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-f3a0a671${_scopeId}>Edit</button>`);
						else _push(`<!---->`);
						if (unref(can)("maintenance.assets.delete")) _push(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-f3a0a671${_scopeId}>Delete</button>`);
						else _push(`<!---->`);
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-f3a0a671${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-f3a0a671${_scopeId}>Save</button>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="form-grid-2" data-v-f3a0a671${_scopeId}>`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<!--[-->`);
									ssrRenderList(props.categories, (c) => {
										_push(`<option${ssrRenderAttr("value", c)} data-v-f3a0a671${_scopeId}>${ssrInterpolate(catLabel(c))}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" data-v-f3a0a671${_scopeId}>Current Outlet</option><!--[-->`);
									ssrRenderList(props.branches, (branch) => {
										_push(`<option${ssrRenderAttr("value", branch.id)} data-v-f3a0a671${_scopeId}>${ssrInterpolate(branch.name)}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" data-v-f3a0a671${_scopeId}>— None —</option><!--[-->`);
									ssrRenderList(props.vendors, (v) => {
										_push(`<option${ssrRenderAttr("value", v.id)} data-v-f3a0a671${_scopeId}>${ssrInterpolate(v.name)}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<!--[-->`);
									ssrRenderList(props.statuses, (s) => {
										_push(`<option${ssrRenderAttr("value", s)} data-v-f3a0a671${_scopeId}>${ssrInterpolate(statusLabel(s))}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(`</div><p class="am__hint" data-v-f3a0a671${_scopeId}>Next service is calculated from the last-serviced date (or purchase date) plus the interval.</p>`);
						_push(ssrRenderComponent(_sfc_main$2, {
...
var Assets_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-f3a0a671"]]);
//#endregion
