    ...
    <body>
      <div class="card">
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-6d1b6105>`);
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("qr.create")) _push(`<button class="ui-btn ui-btn--primary" data-v-6d1b6105${_scopeId}>+ New QR Code</button>`);
						else _push(`<!---->`);
			...
			_push(ssrRenderComponent(DataTable_default, {
				...
				"cell:label": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) _push(`<strong data-v-6d1b6105${_scopeId}>${ssrInterpolate(row.label || "Untitled")}</strong>`);
					else return [createVNode("strong", null, toDisplayString(row.label || "Untitled"), 1)];
				}),
				"cell:location": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (row.table) _push(`<span data-v-6d1b6105${_scopeId}>Table ${ssrInterpolate(row.table)}</span>`);
						else if (row.place_name) _push(`<span data-v-6d1b6105${_scopeId}>${ssrInterpolate(row.place_name)}</span>`);
						else _push(`<span class="qr__muted" data-v-6d1b6105${_scopeId}>Whole menu</span>`);
				...
				"cell:menu_url": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) _push(`<div class="qr__link" data-v-6d1b6105${_scopeId}><a${ssrRenderAttr("href", row.menu_url)} target="_blank" rel="noopener" class="qr__url"${ssrRenderAttr("title", row.menu_url)} data-v-6d1b6105${_scopeId}>${ssrInterpolate(shortUrl(row.menu_url))}</a><button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-6d1b6105${_scopeId}>${ssrInterpolate(copied.value === row.menu_url ? "✓ Copied" : "Copy")}</button></div>`);
				...
				"cell:is_active": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="${ssrRenderClass([value ? "ui-badge--success" : "ui-badge--muted", "ui-badge"])}" data-v-6d1b6105${_scopeId}>${ssrInterpolate(value ? "Active" : "Inactive")}</span>`);
				...
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<button class="ui-btn ui-btn--secondary ui-btn--sm" data-v-6d1b6105${_scopeId}>QR</button>`);
						if (unref(can)("qr.update")) _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-6d1b6105${_scopeId}>Edit</button>`);
						else _push(`<!---->`);
						if (unref(can)("qr.delete")) _push(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-6d1b6105${_scopeId}>Delete</button>`);
						else _push(`<!---->`);
					} else return [
						createVNode("button", {
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-6d1b6105${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-6d1b6105${_scopeId}>Save</button>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" data-v-6d1b6105${_scopeId}>— None (whole menu) —</option><!--[-->`);
									ssrRenderList(props.places, (p) => {
										_push(`<option${ssrRenderAttr("value", p.id)} data-v-6d1b6105${_scopeId}>${ssrInterpolate(p.name)}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" data-v-6d1b6105${_scopeId}>— None —</option><!--[-->`);
									ssrRenderList(tablesForPlace.value, (t) => {
										_push(`<option${ssrRenderAttr("value", t.id)} data-v-6d1b6105${_scopeId}>Table ${ssrInterpolate(t.table_number)}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`<option${ssrRenderAttr("value", true)} data-v-6d1b6105${_scopeId}>Active</option><option${ssrRenderAttr("value", false)} data-v-6d1b6105${_scopeId}>Inactive</option>`);
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--secondary" data-v-6d1b6105${_scopeId}>Download PNG</button><button class="ui-btn ui-btn--ghost" data-v-6d1b6105${_scopeId}>${ssrInterpolate(copied.value === previewRow.value?.menu_url ? "✓ Copied" : "Copy link")}</button><button class="ui-btn ui-btn--primary" data-v-6d1b6105${_scopeId}>Print</button>`);
					else return [
						createVNode("button", {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (previewRow.value) {
							_push(`<div class="qrcard" data-v-6d1b6105${_scopeId}><div class="qrcard__head" data-v-6d1b6105${_scopeId}><span class="qrcard__eyebrow" data-v-6d1b6105${_scopeId}>Scan to order</span>`);
							if (previewRow.value.table) _push(`<span class="qrcard__loc" data-v-6d1b6105${_scopeId}>Table ${ssrInterpolate(previewRow.value.table)}</span>`);
							else if (previewRow.value.place_name) _push(`<span class="qrcard__loc" data-v-6d1b6105${_scopeId}>${ssrInterpolate(previewRow.value.place_name)}</span>`);
							else _push(`<!---->`);
							_push(`</div><div class="qrcard__tile" data-v-6d1b6105${_scopeId}><img${ssrRenderAttr("src", qrSrc(previewRow.value.id))}${ssrRenderAttr("alt", previewRow.value.label || "QR code")} class="qrcard__img" data-v-6d1b6105${_scopeId}></div><p class="qrcard__label" data-v-6d1b6105${_scopeId}>${ssrInterpolate(previewRow.value.label || "Untitled code")}</p><p class="qrcard__hint" data-v-6d1b6105${_scopeId}>Point your phone camera at the code to open the menu.</p><a${ssrRenderAttr("href", previewRow.value.menu_url)} target="_blank" rel="noopener" class="qrcard__url" data-v-6d1b6105${_scopeId}>${ssrInterpolate(previewRow.value.menu_url)}</a></div>`);
						} else _push(`<!---->`);
...
var QRCodes_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-6d1b6105"]]);
//#endregion
