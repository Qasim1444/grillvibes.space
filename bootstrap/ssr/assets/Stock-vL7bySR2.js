...
var _sfc_main = /*@__PURE__*/ Object.assign({ layout: AdminLayout_default }, {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-56204057>`);
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("inventory.stock.adjust")) _push(`<button class="ui-btn ui-btn--secondary" data-v-56204057${_scopeId}> Record Wastage </button>`);
						else _push(`<!---->`);
						if (unref(can)("inventory.stock.adjust")) _push(`<button class="ui-btn ui-btn--primary" data-v-56204057${_scopeId}> Stock Take </button>`);
						else _push(`<!---->`);
			...
			_push(`<div class="st__kpis" data-v-56204057><div class="st__kpi st__kpi--ok" data-v-56204057><span class="st__kpi-label" data-v-56204057>Stock Value</span><span class="st__kpi-val" data-v-56204057>${ssrInterpolate(fmt(props.summary.stock_value))}</span><span class="st__kpi-sub" data-v-56204057>${ssrInterpolate(props.summary.tracked)} ingredient(s) tracked</span></div><div class="st__kpi st__kpi--warn" data-v-56204057><span class="st__kpi-label" data-v-56204057>Low Stock</span><span class="st__kpi-val" data-v-56204057>${ssrInterpolate(props.summary.low_stock)}</span><span class="st__kpi-sub" data-v-56204057>at or below reorder level</span></div><div class="${ssrRenderClass([props.summary.negative > 0 ? "st__kpi--danger" : "", "st__kpi"])}" data-v-56204057><span class="st__kpi-label" data-v-56204057>Negative</span><span class="st__kpi-val" data-v-56204057>${ssrInterpolate(props.summary.negative)}</span><span class="st__kpi-sub" data-v-56204057>count these first</span></div><div class="st__kpi st__kpi--info" data-v-56204057><span class="st__kpi-label" data-v-56204057>Wastage This Month</span><span class="st__kpi-val" data-v-56204057>${ssrInterpolate(fmt(props.summary.wastage_this_month))}</span><span class="st__kpi-sub" data-v-56204057>written off at carrying cost</span></div></div><div class="st__filters" data-v-56204057><input${ssrRenderAttr("value", search.value)} class="ui-input st__search" placeholder="Search ingredient / SKU…" data-v-56204057><div class="st__tabs" data-v-56204057><!--[-->`);
			ssrRenderList(tabs, (tab) => {
				_push(`<button class="${ssrRenderClass([{ "st__tab--on": viewFilter.value === tab.value }, "st__tab"])}" data-v-56204057>${ssrInterpolate(tab.label)}</button>`);
			});
			_push(`<!--]--></div></div>`);
			_push(ssrRenderComponent(DataTable_default, {
				...
				"cell:name": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<strong data-v-56204057${_scopeId}>${ssrInterpolate(row.name)}</strong>`);
						if (row.sku) _push(`<span class="st__muted st__code" data-v-56204057${_scopeId}>${ssrInterpolate(row.sku)}</span>`);
						else _push(`<!---->`);
				...
				"cell:quantity": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<span class="${ssrRenderClass(qtyClass(row))}" data-v-56204057${_scopeId}>${ssrInterpolate(qty(row.quantity))} ${ssrInterpolate(row.unit)}</span>`);
						if (row.quantity < 0) _push(`<span class="ui-badge ui-badge--danger st__pill" data-v-56204057${_scopeId}>Negative</span>`);
						else if (row.needs_reorder) _push(`<span class="ui-badge ui-badge--warning st__pill" data-v-56204057${_scopeId}>Reorder</span>`);
						else _push(`<!---->`);
				...
				"cell:reorder_level": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="st__muted" data-v-56204057${_scopeId}>${ssrInterpolate(qty(row.reorder_level))} ${ssrInterpolate(row.unit)}</span>`);
				...
				"cell:average_cost": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (row.average_cost > 0) _push(`<span data-v-56204057${_scopeId}>${ssrInterpolate(fmt(row.average_cost))}<span class="st__muted" data-v-56204057${_scopeId}> / ${ssrInterpolate(row.unit)}</span></span>`);
						else _push(`<span class="st__muted" data-v-56204057${_scopeId}>—</span>`);
				...
				"cell:stock_value": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<strong data-v-56204057${_scopeId}>${ssrInterpolate(fmt(value))}</strong>`);
					else return [createVNode("strong", null, toDisplayString(fmt(value)), 1)];
				}),
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-56204057${_scopeId}>Ledger</button>`);
						if (unref(can)("inventory.stock.adjust")) _push(`<button class="ui-btn ui-btn--secondary ui-btn--sm" data-v-56204057${_scopeId}>Count</button>`);
						else _push(`<!---->`);
			...
			_push(`<section class="st__feed" data-v-56204057><h3 class="st__feed-title" data-v-56204057>Recent Movements</h3>`);
			if (!props.movements.length) _push(`<p class="st__muted" data-v-56204057>No stock has moved at this outlet yet.</p>`);
			else {
				_push(`<table class="st__feed-table" data-v-56204057><thead data-v-56204057><tr data-v-56204057><th data-v-56204057>When</th><th data-v-56204057>Ingredient</th><th data-v-56204057>Type</th><th class="st__right" data-v-56204057>Change</th><th class="st__right" data-v-56204057>Balance</th><th class="st__right" data-v-56204057>Value</th><th data-v-56204057>Reference</th></tr></thead><tbody data-v-56204057><!--[-->`);
				ssrRenderList(props.movements, (m) => {
					_push(`<tr data-v-56204057><td class="st__muted st__nowrap" data-v-56204057>${ssrInterpolate(fmtDateTime(m.created_at))}</td><td data-v-56204057>${ssrInterpolate(m.ingredient_name)}</td><td data-v-56204057><span class="${ssrRenderClass([typeBadge(m.type), "ui-badge"])}" data-v-56204057>${ssrInterpolate(typeLabel(m.type))}</span></td><td class="${ssrRenderClass([m.quantity < 0 ? "st__out" : "st__in", "st__right"])}" data-v-56204057>${ssrInterpolate(m.quantity > 0 ? "+" : "")}${ssrInterpolate(qty(m.quantity))} ${ssrInterpolate(m.unit)}</td><td class="st__right" data-v-56204057>${ssrInterpolate(qty(m.balance_after))}</td><td class="st__right st__muted" data-v-56204057>${ssrInterpolate(fmt(m.value))}</td><td class="st__muted" data-v-56204057>${ssrInterpolate(m.reference || "—")} `);
					if (m.note) _push(`<span class="st__note"${ssrRenderAttr("title", m.note)} data-v-56204057>${ssrInterpolate(m.note)}</span>`);
					else _push(`<!---->`);
					_push(`</td></tr>`);
				});
				_push(`<!--]--></tbody></table>`);
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-56204057${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(countForm).processing) ? " disabled" : ""} data-v-56204057${_scopeId}>Record Count</button>`);
					else return [createVNode("button", {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<p class="st__hint" data-v-56204057${_scopeId}> Enter what you physically counted. The system writes the difference to the ledger as an adjustment — it does not create value, so the ingredient keeps its existing average cost. </p>`);
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" data-v-56204057${_scopeId}>Select an ingredient…</option><!--[-->`);
									ssrRenderList(props.ingredients, (i) => {
										_push(`<option${ssrRenderAttr("value", i.id)} data-v-56204057${_scopeId}>${ssrInterpolate(i.name)} (${ssrInterpolate(i.unit)})</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(`<div class="form-grid-2" data-v-56204057${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$2, {
						...
						if (countDelta.value !== null) {
							_push(`<p class="${ssrRenderClass([countDelta.value === 0 ? "" : countDelta.value > 0 ? "st__in" : "st__out", "st__delta"])}" data-v-56204057${_scopeId}>`);
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-56204057${_scopeId}>Cancel</button><button class="ui-btn ui-btn--danger"${ssrIncludeBooleanAttr(unref(wasteForm).processing) ? " disabled" : ""} data-v-56204057${_scopeId}>Write Off</button>`);
					else return [createVNode("button", {
						class: "ui-btn ui-btn--ghost",
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<p class="st__hint" data-v-56204057${_scopeId}> Stock that was spoiled, spilled or binned. It leaves at its carrying cost and lands in this month&#39;s wastage figure — use a stock take instead if you are correcting a counting error. </p>`);
						_push(ssrRenderComponent(_sfc_main$2, {
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-56204057${_scopeId}>Close</button>`);
					else return [createVNode("button", {
						class: "ui-btn ui-btn--ghost",
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (ledgerLoading.value) _push(`<p class="st__muted" data-v-56204057${_scopeId}>Loading…</p>`);
						else if (ledgerError.value) _push(`<p class="st__out" data-v-56204057${_scopeId}>${ssrInterpolate(ledgerError.value)}</p>`);
						else if (!ledger.value.length) _push(`<p class="st__muted" data-v-56204057${_scopeId}>No movements recorded for this ingredient.</p>`);
						else {
							_push(`<table class="st__feed-table" data-v-56204057${_scopeId}><thead data-v-56204057${_scopeId}><tr data-v-56204057${_scopeId}><th data-v-56204057${_scopeId}>When</th><th data-v-56204057${_scopeId}>Type</th><th class="st__right" data-v-56204057${_scopeId}>Change</th><th class="st__right" data-v-56204057${_scopeId}>Unit Cost</th><th class="st__right" data-v-56204057${_scopeId}>Balance</th><th class="st__right" data-v-56204057${_scopeId}>Value</th><th data-v-56204057${_scopeId}>Reference</th></tr></thead><tbody data-v-56204057${_scopeId}><!--[-->`);
							ssrRenderList(ledger.value, (m) => {
								_push(`<tr data-v-56204057${_scopeId}><td class="st__muted st__nowrap" data-v-56204057${_scopeId}>${ssrInterpolate(fmtDateTime(m.created_at))}</td><td data-v-56204057${_scopeId}><span class="${ssrRenderClass([typeBadge(m.type), "ui-badge"])}" data-v-56204057${_scopeId}>${ssrInterpolate(typeLabel(m.type))}</span></td><td class="${ssrRenderClass([m.quantity < 0 ? "st__out" : "st__in", "st__right"])}" data-v-56204057${_scopeId}>${ssrInterpolate(m.quantity > 0 ? "+" : "")}${ssrInterpolate(qty(m.quantity))}</td><td class="st__right st__muted" data-v-56204057${_scopeId}>${ssrInterpolate(fmt(m.unit_cost))}</td><td class="st__right" data-v-56204057${_scopeId}>${ssrInterpolate(qty(m.balance_after))}</td><td class="st__right st__muted" data-v-56204057${_scopeId}>${ssrInterpolate(fmt(m.value))}</td><td class="st__muted" data-v-56204057${_scopeId}>${ssrInterpolate(m.reference || m.note || "—")}</td></tr>`);
							});
							_push(`<!--]--></tbody></table>`);
						}
...
var Stock_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-56204057"]]);
//#endregion
