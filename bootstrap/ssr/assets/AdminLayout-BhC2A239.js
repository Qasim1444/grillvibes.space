...
var _sfc_main$2 = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			}, "sidebar"])}" data-v-37d3812b><div class="sidebar__brand" data-v-37d3812b><div class="${ssrRenderClass([{ "sidebar__logo--image": logoUrl.value && !logoFailed.value }, "sidebar__logo"])}" data-v-37d3812b>`);
			if (logoUrl.value && !logoFailed.value) _push(`<img${ssrRenderAttr("src", logoUrl.value)} alt="GrillVibes logo" data-v-37d3812b>`);
			else _push(`<span data-v-37d3812b>G</span>`);
			_push(`</div><span class="sidebar__brand-name" data-v-37d3812b>${ssrInterpolate(unref(page).props.branding?.name ?? "GrillVibes")}</span></div><nav class="sidebar__nav" data-v-37d3812b><!--[-->`);
			ssrRenderList(visibleGroups.value, (group) => {
				_push(`<!--[--><div class="sidebar__group-title" data-v-37d3812b>${ssrInterpolate(group.title)}</div><!--[-->`);
				ssrRenderList(group.items, (item) => {
					_push(ssrRenderComponent(unref(Link), {
						...
						default: withCtx((_, _push, _parent, _scopeId) => {
							if (_push) _push(`<span class="sidebar__icon" data-v-37d3812b${_scopeId}>${item.icon ?? ""}</span><span class="sidebar__label" data-v-37d3812b${_scopeId}>${ssrInterpolate(item.label)}</span>`);
			...
			_push(`<!--]--></nav></aside>`);
			if (unref(state).mobileOpen) _push(`<div class="sidebar__backdrop" data-v-37d3812b></div>`);
			else _push(`<!---->`);
			_push(`<!--]-->`);
		};
	}
...
var Sidebar_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main$2, [["__scopeId", "data-v-37d3812b"]]);
//#endregion
