...
var _sfc_main = /*@__PURE__*/ Object.assign({ layout: AdminLayout_default }, {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-4ca25eb8>`);
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("inventory.ingredients.create")) _push(`<button class="ui-btn ui-btn--primary" data-v-4ca25eb8${_scopeId}> + New Ingredient </button>`);
						else _push(`<!---->`);
			...
			_push(`<div class="ing__kpis" data-v-4ca25eb8><div class="ing__kpi ing__kpi--info" data-v-4ca25eb8><span class="ing__kpi-label" data-v-4ca25eb8>Ingredients</span><span class="ing__kpi-val" data-v-4ca25eb8>${ssrInterpolate(props.summary.total)}</span><span class="ing__kpi-sub" data-v-4ca25eb8>on the master list</span></div><div class="ing__kpi ing__kpi--ok" data-v-4ca25eb8><span class="ing__kpi-label" data-v-4ca25eb8>Stock Value</span><span class="ing__kpi-val" data-v-4ca25eb8>${ssrInterpolate(fmt(props.summary.stock_value))}</span><span class="ing__kpi-sub" data-v-4ca25eb8>at this outlet</span></div><div class="ing__kpi ing__kpi--warn" data-v-4ca25eb8><span class="ing__kpi-label" data-v-4ca25eb8>Low Stock</span><span class="ing__kpi-val" data-v-4ca25eb8>${ssrInterpolate(props.summary.low_stock)}</span><span class="ing__kpi-sub" data-v-4ca25eb8>at or below reorder level</span></div><div class="${ssrRenderClass([props.summary.negative > 0 ? "ing__kpi--danger" : "", "ing__kpi"])}" data-v-4ca25eb8><span class="ing__kpi-label" data-v-4ca25eb8>Negative</span><span class="ing__kpi-val" data-v-4ca25eb8>${ssrInterpolate(props.summary.negative)}</span><span class="ing__kpi-sub" data-v-4ca25eb8>sold more than was received</span></div></div><div class="ing__filters" data-v-4ca25eb8><input${ssrRenderAttr("value", search.value)} class="ui-input ing__search" placeholder="Search name / SKU…" data-v-4ca25eb8><select class="ui-input" style="${ssrRenderStyle({ "width": "160px" })}" data-v-4ca25eb8><option value="" data-v-4ca25eb8${ssrIncludeBooleanAttr(Array.isArray(statusFilter.value) ? ssrLooseContain(statusFilter.value, "") : ssrLooseEqual(statusFilter.value, "")) ? " selected" : ""}>All Statuses</option><option value="active" data-v-4ca25eb8${ssrIncludeBooleanAttr(Array.isArray(statusFilter.value) ? ssrLooseContain(statusFilter.value, "active") : ssrLooseEqual(statusFilter.value, "active")) ? " selected" : ""}>Active</option><option value="inactive" data-v-4ca25eb8${ssrIncludeBooleanAttr(Array.isArray(statusFilter.value) ? ssrLooseContain(statusFilter.value, "inactive") : ssrLooseEqual(statusFilter.value, "inactive")) ? " selected" : ""}>Inactive</option></select></div>`);
			_push(ssrRenderComponent(DataTable_default, {
				...
				"cell:name": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<strong data-v-4ca25eb8${_scopeId}>${ssrInterpolate(row.name)}</strong>`);
						if (row.sku) _push(`<span class="ing__code" data-v-4ca25eb8${_scopeId}>${ssrInterpolate(row.sku)}</span>`);
						else _push(`<!---->`);
						if (!row.is_active) _push(`<span class="ui-badge ui-badge--muted ing__pill" data-v-4ca25eb8${_scopeId}>Inactive</span>`);
						else _push(`<!---->`);
					} else return [
				...
				"cell:quantity": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<span class="${ssrRenderClass(qtyClass(row))}" data-v-4ca25eb8${_scopeId}>${ssrInterpolate(qty(row.quantity))} ${ssrInterpolate(row.unit)}</span>`);
						if (row.needs_reorder) _push(`<span class="ui-badge ui-badge--warning ing__pill" data-v-4ca25eb8${_scopeId}>Reorder</span>`);
						else _push(`<!---->`);
				...
				"cell:reorder_level": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="ing__muted" data-v-4ca25eb8${_scopeId}>${ssrInterpolate(qty(row.reorder_level))} ${ssrInterpolate(row.unit)}</span>`);
				...
				"cell:average_cost": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (row.average_cost > 0) _push(`<span data-v-4ca25eb8${_scopeId}>${ssrInterpolate(fmt(row.average_cost))} <span class="ing__muted" data-v-4ca25eb8${_scopeId}>/ ${ssrInterpolate(row.unit)}</span></span>`);
						else _push(`<span class="ing__muted" title="No delivery has been booked yet, so there is no valuation." data-v-4ca25eb8${_scopeId}>—</span>`);
				...
				"cell:stock_value": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<strong data-v-4ca25eb8${_scopeId}>${ssrInterpolate(fmt(value))}</strong>`);
					else return [createVNode("strong", null, toDisplayString(fmt(value)), 1)];
				}),
				"cell:used_in_recipes": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) {
						if (value > 0) _push(`<span class="ui-badge ui-badge--info" data-v-4ca25eb8${_scopeId}>${ssrInterpolate(value)} dish${ssrInterpolate(value === 1 ? "" : "es")}</span>`);
						else _push(`<span class="ing__muted" data-v-4ca25eb8${_scopeId}>unused</span>`);
				...
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("inventory.ingredients.update")) _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-4ca25eb8${_scopeId}>Edit</button>`);
						else _push(`<!---->`);
						if (unref(can)("inventory.ingredients.delete")) _push(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-4ca25eb8${_scopeId}>Delete</button>`);
						else _push(`<!---->`);
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-4ca25eb8${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-4ca25eb8${_scopeId}>Save</button>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<div class="form-grid-2" data-v-4ca25eb8${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									...
									ssrRenderList(props.units, (u) => {
										_push(`<option${ssrRenderAttr("value", u)} data-v-4ca25eb8${_scopeId}>${ssrInterpolate(u)}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`<option${ssrRenderAttr("value", true)} data-v-4ca25eb8${_scopeId}>Active</option><option${ssrRenderAttr("value", false)} data-v-4ca25eb8${_scopeId}>Inactive</option>`);
								else return [createVNode("option", { value: true }, "Active"), createVNode("option", { value: false }, "Inactive")];
							}),
							_: 1
						}, _parent, _scopeId));
						_push(`</div><p class="ing__hint" data-v-4ca25eb8${_scopeId}> The unit is how this ingredient is counted, bought and used in recipes — pick it once and stick to it, because every quantity and cost in the system is expressed in it. Flag the ingredient when stock drops to the reorder level. </p>`);
						_push(ssrRenderComponent(_sfc_main$2, {
...
var Ingredients_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-4ca25eb8"]]);
//#endregion
