...
var _sfc_main = /*@__PURE__*/ Object.assign({ layout: AdminLayout_default }, {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-1442a70e>`);
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("procurement.vendors.create")) _push(`<button class="ui-btn ui-btn--primary" data-v-1442a70e${_scopeId}> + New Vendor </button>`);
						else _push(`<!---->`);
			...
			_push(`<div class="vd__kpis" data-v-1442a70e><div class="vd__kpi vd__kpi--info" data-v-1442a70e><span class="vd__kpi-label" data-v-1442a70e>Vendors</span><span class="vd__kpi-val" data-v-1442a70e>${ssrInterpolate(props.summary.total)}</span><span class="vd__kpi-sub" data-v-1442a70e>${ssrInterpolate(props.summary.active)} active</span></div><div class="vd__kpi vd__kpi--warn" data-v-1442a70e><span class="vd__kpi-label" data-v-1442a70e>Awaiting Delivery</span><span class="vd__kpi-val" data-v-1442a70e>${ssrInterpolate(props.summary.with_open_orders)}</span><span class="vd__kpi-sub" data-v-1442a70e>vendors with open orders</span></div><div class="vd__kpi vd__kpi--ok" data-v-1442a70e><span class="vd__kpi-label" data-v-1442a70e>Received This Month</span><span class="vd__kpi-val" data-v-1442a70e>${ssrInterpolate(fmt(props.summary.spend_this_month))}</span><span class="vd__kpi-sub" data-v-1442a70e>goods actually delivered</span></div></div><div class="vd__filters" data-v-1442a70e><input${ssrRenderAttr("value", search.value)} class="ui-input vd__search" placeholder="Search name / contact / phone / email…" data-v-1442a70e><select class="ui-input" style="${ssrRenderStyle({ "width": "160px" })}" data-v-1442a70e><option value="" data-v-1442a70e${ssrIncludeBooleanAttr(Array.isArray(statusFilter.value) ? ssrLooseContain(statusFilter.value, "") : ssrLooseEqual(statusFilter.value, "")) ? " selected" : ""}>All Statuses</option><option value="active" data-v-1442a70e${ssrIncludeBooleanAttr(Array.isArray(statusFilter.value) ? ssrLooseContain(statusFilter.value, "active") : ssrLooseEqual(statusFilter.value, "active")) ? " selected" : ""}>Active</option><option value="inactive" data-v-1442a70e${ssrIncludeBooleanAttr(Array.isArray(statusFilter.value) ? ssrLooseContain(statusFilter.value, "inactive") : ssrLooseEqual(statusFilter.value, "inactive")) ? " selected" : ""}>Inactive</option></select></div>`);
			_push(ssrRenderComponent(DataTable_default, {
				...
				"cell:name": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<strong data-v-1442a70e${_scopeId}>${ssrInterpolate(row.name)}</strong>`);
						if (!row.is_active) _push(`<span class="ui-badge ui-badge--muted vd__pill" data-v-1442a70e${_scopeId}>Inactive</span>`);
						else _push(`<!---->`);
						if (row.contact_person) _push(`<span class="vd__sub" data-v-1442a70e${_scopeId}>${ssrInterpolate(row.contact_person)}</span>`);
						else _push(`<!---->`);
					} else return [
				...
				"cell:contact": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (row.phone) _push(`<span class="vd__block" data-v-1442a70e${_scopeId}>${ssrInterpolate(row.phone)}</span>`);
						else _push(`<!---->`);
						if (row.email) _push(`<span class="vd__block vd__muted" data-v-1442a70e${_scopeId}>${ssrInterpolate(row.email)}</span>`);
						else _push(`<!---->`);
						if (!row.phone && !row.email) _push(`<span class="vd__muted" data-v-1442a70e${_scopeId}>—</span>`);
						else _push(`<!---->`);
					} else return [
				...
				"cell:payment_terms": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) {
						if (value) _push(`<span data-v-1442a70e${_scopeId}>${ssrInterpolate(value)}</span>`);
						else _push(`<span class="vd__muted" data-v-1442a70e${_scopeId}>—</span>`);
				...
				"cell:purchase_orders": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<span data-v-1442a70e${_scopeId}>${ssrInterpolate(row.purchase_orders)}</span>`);
						if (row.open_purchase_orders > 0) _push(`<span class="ui-badge ui-badge--warning vd__pill" data-v-1442a70e${_scopeId}>${ssrInterpolate(row.open_purchase_orders)} open </span>`);
						else _push(`<!---->`);
				...
				"cell:received_total": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) _push(`<strong data-v-1442a70e${_scopeId}>${ssrInterpolate(fmt(row.received_total))}</strong><span class="vd__sub" data-v-1442a70e${_scopeId}>${ssrInterpolate(row.goods_receipts)} delivery(s)</span>`);
				...
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("procurement.vendors.update")) _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-1442a70e${_scopeId}>Edit</button>`);
						else _push(`<!---->`);
						if (unref(can)("procurement.vendors.delete")) _push(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-1442a70e${_scopeId}>Delete</button>`);
						else _push(`<!---->`);
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-1442a70e${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-1442a70e${_scopeId}>Save</button>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<div class="form-grid-2" data-v-1442a70e${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$2, {
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`<option${ssrRenderAttr("value", true)} data-v-1442a70e${_scopeId}>Active</option><option${ssrRenderAttr("value", false)} data-v-1442a70e${_scopeId}>Inactive</option>`);
						...
						_push(`<p class="vd__hint" data-v-1442a70e${_scopeId}> Mark a vendor inactive to keep it off new purchase orders without touching its history. </p>`);
					} else return [
...
var Vendors_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-1442a70e"]]);
//#endregion
