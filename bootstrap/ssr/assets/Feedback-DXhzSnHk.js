		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("crm.feedback.create")) _push(`<button class="ui-btn ui-btn--primary" data-v-d054531d${_scopeId}> + Record Feedback </button>`);
						else _push(`<!---->`);
			...
			if (flashError.value) _push(`<div class="ui-alert ui-alert--danger" data-v-d054531d>${ssrInterpolate(flashError.value)}</div>`);
			else _push(`<!---->`);
			...
			_push(ssrRenderComponent(_sfc_main$2, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<option value="" data-v-d054531d${_scopeId}>Any rating</option><!--[-->`);
						ssrRenderList([
							5,
							4,
							3,
							...
							_push(`<option${ssrRenderAttr("value", r)} data-v-d054531d${_scopeId}>${ssrInterpolate(r)} star${ssrInterpolate(r === 1 ? "" : "s")}</option>`);
						});
						_push(`<!--]-->`);
			...
			_push(ssrRenderComponent(_sfc_main$2, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<option value="" data-v-d054531d${_scopeId}>All</option><option value="unanswered" data-v-d054531d${_scopeId}>Awaiting reply</option><option value="answered" data-v-d054531d${_scopeId}>Answered</option><option value="published" data-v-d054531d${_scopeId}>Published</option>`);
					else return [
			...
			_push(ssrRenderComponent(DataTable_default, {
				...
				"cell:customer_name": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="fb__who" data-v-d054531d${_scopeId}><strong data-v-d054531d${_scopeId}>${ssrInterpolate(row.customer_name ?? "Walk-in")}</strong>`);
						if (row.customer_contact) _push(`<span class="fb__meta" data-v-d054531d${_scopeId}>${ssrInterpolate(row.customer_contact)}</span>`);
						else _push(`<!---->`);
						_push(`</div>`);
				...
				"cell:rating": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="fb__stars"${ssrRenderAttr("title", `${value} of 5`)} data-v-d054531d${_scopeId}>${ssrInterpolate(stars(value))}</span>`);
				...
				"cell:comment": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="fb__wrap" data-v-d054531d${_scopeId}>${ssrInterpolate(value || "—")}</span>`);
					else return [createVNode("span", { class: "fb__wrap" }, toDisplayString(value || "—"), 1)];
				}),
				"cell:reply": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (row.reply) _push(`<div class="fb__who" data-v-d054531d${_scopeId}><span class="fb__wrap" data-v-d054531d${_scopeId}>${ssrInterpolate(row.reply)}</span><span class="fb__meta" data-v-d054531d${_scopeId}>${ssrInterpolate(row.responder_name)} · ${ssrInterpolate(row.replied_at)}</span></div>`);
						else _push(`<span class="ui-badge ui-badge--warning" data-v-d054531d${_scopeId}>Awaiting reply</span>`);
				...
				"cell:is_published": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="${ssrRenderClass([value ? "ui-badge--success" : "ui-badge--muted", "ui-badge"])}" data-v-d054531d${_scopeId}>${ssrInterpolate(value ? "Published" : "Hidden")}</span>`);
				...
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("crm.feedback.update")) _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-d054531d${_scopeId}>${ssrInterpolate(row.reply ? "Edit Reply" : "Reply")}</button>`);
						else _push(`<!---->`);
						if (unref(can)("crm.feedback.update")) _push(`<button class="${ssrRenderClass([row.is_published ? "ui-btn--ghost" : "ui-btn--success", "ui-btn ui-btn--sm"])}" data-v-d054531d${_scopeId}>${ssrInterpolate(row.is_published ? "Unpublish" : "Publish")}</button>`);
						else _push(`<!---->`);
						if (unref(can)("crm.feedback.update")) _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-d054531d${_scopeId}> Edit </button>`);
						else _push(`<!---->`);
						if (unref(can)("crm.feedback.delete")) _push(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-d054531d${_scopeId}> Delete </button>`);
						else _push(`<!---->`);
					} else return [
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-d054531d${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-d054531d${_scopeId}>Save</button>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<div class="fb__grid" data-v-d054531d${_scopeId}>`);
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									...
									ssrRenderList([
										...
										_push(`<option${ssrRenderAttr("value", r)} data-v-d054531d${_scopeId}>${ssrInterpolate(stars(r))} — ${ssrInterpolate(r)}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`<option${ssrRenderAttr("value", false)} data-v-d054531d${_scopeId}>Hidden</option><option${ssrRenderAttr("value", true)} data-v-d054531d${_scopeId}>Published</option>`);
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-d054531d${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(rForm).processing) ? " disabled" : ""} data-v-d054531d${_scopeId}>Save Reply</button>`);
					else return [createVNode("button", {
						class: "ui-btn ui-btn--ghost",
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (active.value) _push(`<div class="fb__quote" data-v-d054531d${_scopeId}><span class="fb__stars" data-v-d054531d${_scopeId}>${ssrInterpolate(stars(active.value.rating))}</span><p data-v-d054531d${_scopeId}>${ssrInterpolate(active.value.comment || "No comment left.")}</p><span class="fb__meta" data-v-d054531d${_scopeId}>${ssrInterpolate(active.value.customer_name ?? "Walk-in")} · ${ssrInterpolate(active.value.created_at)}</span></div>`);
						else _push(`<!---->`);
						_push(ssrRenderComponent(_sfc_main$2, {
...
var Feedback_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-d054531d"]]);
//#endregion
