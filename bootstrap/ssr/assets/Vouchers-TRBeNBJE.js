...
var _sfc_main = /*@__PURE__*/ Object.assign({ layout: AdminLayout_default }, {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-1b6b9244>`);
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("vouchers.create")) _push(`<button class="ui-btn ui-btn--primary" data-v-1b6b9244${_scopeId}>+ New Voucher</button>`);
						else _push(`<!---->`);
			...
			_push(`<div class="vc__kpis" data-v-1b6b9244><div class="vc__kpi vc__kpi--warn" data-v-1b6b9244><span class="vc__kpi-label" data-v-1b6b9244>Pending</span><span class="vc__kpi-val" data-v-1b6b9244>${ssrInterpolate(props.summary.pending)}</span><span class="vc__kpi-sub" data-v-1b6b9244>awaiting approval</span></div><div class="vc__kpi" data-v-1b6b9244><span class="vc__kpi-label" data-v-1b6b9244>Pending Amount</span><span class="vc__kpi-val" data-v-1b6b9244>${ssrInterpolate(fmt(props.summary.pending_amount))}</span><span class="vc__kpi-sub" data-v-1b6b9244>already out of the funds</span></div><div class="vc__kpi vc__kpi--info" data-v-1b6b9244><span class="vc__kpi-label" data-v-1b6b9244>Claimed (mo.)</span><span class="vc__kpi-val" data-v-1b6b9244>${ssrInterpolate(fmt(props.summary.claimed_this_month))}</span><span class="vc__kpi-sub" data-v-1b6b9244>this month, excl. rejected</span></div><div class="vc__kpi vc__kpi--ok" data-v-1b6b9244><span class="vc__kpi-label" data-v-1b6b9244>Approved (mo.)</span><span class="vc__kpi-val" data-v-1b6b9244>${ssrInterpolate(fmt(props.summary.approved_this_month))}</span><span class="vc__kpi-sub" data-v-1b6b9244>signed off this month</span></div></div><div class="vc__filters" data-v-1b6b9244><input${ssrRenderAttr("value", search.value)} class="ui-input vc__search" placeholder="Search # / purpose / claimant…" data-v-1b6b9244><select class="ui-input" style="${ssrRenderStyle({ "width": "150px" })}" data-v-1b6b9244><option value="" data-v-1b6b9244${ssrIncludeBooleanAttr(Array.isArray(statusFilter.value) ? ssrLooseContain(statusFilter.value, "") : ssrLooseEqual(statusFilter.value, "")) ? " selected" : ""}>All Statuses</option><!--[-->`);
			ssrRenderList(props.statuses, (s) => {
				_push(`<option${ssrRenderAttr("value", s)} data-v-1b6b9244${ssrIncludeBooleanAttr(Array.isArray(statusFilter.value) ? ssrLooseContain(statusFilter.value, s) : ssrLooseEqual(statusFilter.value, s)) ? " selected" : ""}>${ssrInterpolate(statusLabel(s))}</option>`);
			});
			_push(`<!--]--></select><select class="ui-input" style="${ssrRenderStyle({ "width": "220px" })}" data-v-1b6b9244><option value="" data-v-1b6b9244${ssrIncludeBooleanAttr(Array.isArray(accountFilter.value) ? ssrLooseContain(accountFilter.value, "") : ssrLooseEqual(accountFilter.value, "")) ? " selected" : ""}>All Funds</option><!--[-->`);
			ssrRenderList(props.accounts, (a) => {
				_push(`<option${ssrRenderAttr("value", a.id)} data-v-1b6b9244${ssrIncludeBooleanAttr(Array.isArray(accountFilter.value) ? ssrLooseContain(accountFilter.value, a.id) : ssrLooseEqual(accountFilter.value, a.id)) ? " selected" : ""}>${ssrInterpolate(a.name)}</option>`);
			});
			_push(`<!--]--></select><select class="ui-input" style="${ssrRenderStyle({ "width": "180px" })}" data-v-1b6b9244><option value="" data-v-1b6b9244${ssrIncludeBooleanAttr(Array.isArray(branchFilter.value) ? ssrLooseContain(branchFilter.value, "") : ssrLooseEqual(branchFilter.value, "")) ? " selected" : ""}>All Branches</option><!--[-->`);
			ssrRenderList(props.branches, (branch) => {
				_push(`<option${ssrRenderAttr("value", branch.id)} data-v-1b6b9244${ssrIncludeBooleanAttr(Array.isArray(branchFilter.value) ? ssrLooseContain(branchFilter.value, branch.id) : ssrLooseEqual(branchFilter.value, branch.id)) ? " selected" : ""}>${ssrInterpolate(branch.name)}</option>`);
			});
			_push(`<!--]--></select></div>`);
			_push(ssrRenderComponent(DataTable_default, {
				...
				"cell:claimant_label": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) {
						if (value) _push(`<span data-v-1b6b9244${_scopeId}>${ssrInterpolate(value)}</span>`);
						else _push(`<span class="vc__muted" data-v-1b6b9244${_scopeId}>—</span>`);
				...
				"cell:purpose": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						...
						if (row.reference) _push(`<span class="vc__code" data-v-1b6b9244${_scopeId}>${ssrInterpolate(row.reference)}</span>`);
						else _push(`<!---->`);
				...
				"cell:expenses": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (!row.expenses.length) _push(`<span class="vc__muted" data-v-1b6b9244${_scopeId}>—</span>`);
						else _push(`<!---->`);
						_push(`<!--[-->`);
						ssrRenderList(row.expenses, (e) => {
							_push(`<span class="vc__chip"${ssrRenderAttr("title", e.description)} data-v-1b6b9244${_scopeId}>${ssrInterpolate(e.expense_number)}</span>`);
						});
						_push(`<!--]-->`);
				...
				"cell:amount": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<strong data-v-1b6b9244${_scopeId}>${ssrInterpolate(fmt(value))}</strong>`);
					else return [createVNode("strong", null, toDisplayString(fmt(value)), 1)];
				}),
				"cell:status": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<span class="${ssrRenderClass([statusClass(row.status), "ui-badge"])}" data-v-1b6b9244${_scopeId}>${ssrInterpolate(statusLabel(row.status))}</span>`);
						if (row.rejection_reason) _push(`<span class="vc__code"${ssrRenderAttr("title", row.rejection_reason)} data-v-1b6b9244${_scopeId}>why?</span>`);
						else _push(`<!---->`);
				...
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("vouchers.approve") && row.status === "pending") _push(`<button class="ui-btn ui-btn--secondary ui-btn--sm" data-v-1b6b9244${_scopeId}>Approve</button>`);
						else _push(`<!---->`);
						if (unref(can)("vouchers.approve") && row.status === "pending") _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-1b6b9244${_scopeId}>Reject</button>`);
						else _push(`<!---->`);
						if (unref(can)("vouchers.update") && row.status === "pending") _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-1b6b9244${_scopeId}>Edit</button>`);
						else _push(`<!---->`);
						if (unref(can)("vouchers.delete")) _push(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-1b6b9244${_scopeId}>Delete</button>`);
						else _push(`<!---->`);
					} else return [
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-1b6b9244${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-1b6b9244${_scopeId}>Save</button>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<div class="form-grid-2" data-v-1b6b9244${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" data-v-1b6b9244${_scopeId}>— Not a system user —</option><!--[-->`);
									ssrRenderList(props.claimants, (c) => {
										_push(`<option${ssrRenderAttr("value", c.id)} data-v-1b6b9244${_scopeId}>${ssrInterpolate(c.name)}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" disabled data-v-1b6b9244${_scopeId}>Select fund</option><!--[-->`);
									ssrRenderList(props.accounts, (a) => {
										_push(`<option${ssrRenderAttr("value", a.id)} data-v-1b6b9244${_scopeId}>${ssrInterpolate(a.name)} (${ssrInterpolate(fmt(a.current_balance))})</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" data-v-1b6b9244${_scopeId}>Current Outlet</option><!--[-->`);
									ssrRenderList(props.branches, (branch) => {
										_push(`<option${ssrRenderAttr("value", branch.id)} data-v-1b6b9244${_scopeId}>${ssrInterpolate(branch.name)}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(`</div><h3 class="vc__picker-title" data-v-1b6b9244${_scopeId}> Expenses Claimed * <span class="vc__muted vc__picker-hint" data-v-1b6b9244${_scopeId}>${ssrInterpolate(pickerHint.value)}</span></h3>`);
						if (unref(form).errors.expense_ids) _push(`<p class="vc__err" data-v-1b6b9244${_scopeId}>${ssrInterpolate(unref(form).errors.expense_ids)}</p>`);
						else _push(`<!---->`);
						_push(`<div class="vc__picker" data-v-1b6b9244${_scopeId}>`);
						if (!pickable.value.length) _push(`<p class="vc__muted vc__picker-empty" data-v-1b6b9244${_scopeId}>No unclaimed expenses available. Record an expense first.</p>`);
						else _push(`<!---->`);
						_push(`<!--[-->`);
						ssrRenderList(pickable.value, (e) => {
							_push(`<label class="${ssrRenderClass([{ "vc__row--on": isPicked(e.id) }, "vc__row"])}" data-v-1b6b9244${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(isPicked(e.id)) ? " checked" : ""} data-v-1b6b9244${_scopeId}><span class="vc__row-num" data-v-1b6b9244${_scopeId}>${ssrInterpolate(e.expense_number)}</span><span class="vc__row-desc" data-v-1b6b9244${_scopeId}>${ssrInterpolate(e.description)} <span class="vc__code" data-v-1b6b9244${_scopeId}>${ssrInterpolate(fmtDate(e.expense_date))} · ${ssrInterpolate(paidViaLabel(e.paid_via))}</span></span><span class="vc__row-amt" data-v-1b6b9244${_scopeId}>${ssrInterpolate(fmt(e.amount))}</span></label>`);
						});
						_push(`<!--]--></div><div class="vc__totals" data-v-1b6b9244${_scopeId}><div class="vc__total-row" data-v-1b6b9244${_scopeId}><span data-v-1b6b9244${_scopeId}>Total claim</span><strong data-v-1b6b9244${_scopeId}>${ssrInterpolate(fmt(claimTotal.value))}</strong></div>`);
						if (selectedFund.value) _push(`<div class="${ssrRenderClass([{ "vc__over": balanceAfter.value < 0 }, "vc__total-row vc__total-row--sub"])}" data-v-1b6b9244${_scopeId}><span data-v-1b6b9244${_scopeId}>${ssrInterpolate(selectedFund.value.name)} balance after</span><strong data-v-1b6b9244${_scopeId}>${ssrInterpolate(fmt(balanceAfter.value))}</strong></div>`);
						else _push(`<!---->`);
						if (selectedFund.value && balanceAfter.value < 0) _push(`<p class="vc__err" data-v-1b6b9244${_scopeId}> This claim is larger than the fund holds — top the float up, or split the claim. </p>`);
						else _push(`<!---->`);
						_push(`</div>`);
						_push(ssrRenderComponent(_sfc_main$2, {
						...
						_push(`<p class="vc__hint" data-v-1b6b9244${_scopeId}>Raising the voucher posts one combined disbursement to the fund&#39;s ledger. A claimed expense stops posting its own petty-cash line, so a petty-cash expense is never deducted twice.</p>`);
					} else return [
...
var Vouchers_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-1b6b9244"]]);
//#endregion
