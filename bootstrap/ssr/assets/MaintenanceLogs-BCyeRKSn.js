		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("maintenance.logs.create")) _push(`<button class="ui-btn ui-btn--primary" data-v-3ad82f84${_scopeId}>+ Log Maintenance</button>`);
						else _push(`<!---->`);
			...
			_push(ssrRenderComponent(DataTable_default, {
				...
				"cell:asset": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) _push(`<strong data-v-3ad82f84${_scopeId}>${ssrInterpolate(row.asset_name)}</strong><span class="ml__code" data-v-3ad82f84${_scopeId}>${ssrInterpolate(row.asset_code)}</span>`);
				...
				"cell:type": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="ui-badge ui-badge--muted" data-v-3ad82f84${_scopeId}>${ssrInterpolate(titleize(value))}</span>`);
				...
				"cell:performed_by": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (row.performed_by || row.vendor_name) _push(`<span data-v-3ad82f84${_scopeId}>${ssrInterpolate(row.performed_by || row.vendor_name)}</span>`);
						else _push(`<span class="ml__muted" data-v-3ad82f84${_scopeId}>—</span>`);
				...
				"cell:status": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="${ssrRenderClass([statusClass(value), "ui-badge"])}" data-v-3ad82f84${_scopeId}>${ssrInterpolate(statusLabel(value))}</span>`);
				...
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("maintenance.logs.update") && !["completed", "cancelled"].includes(row.status)) _push(`<button class="ui-btn ui-btn--secondary ui-btn--sm" data-v-3ad82f84${_scopeId}>Complete</button>`);
						else _push(`<!---->`);
						if (unref(can)("maintenance.logs.update")) _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-3ad82f84${_scopeId}>Edit</button>`);
						else _push(`<!---->`);
						if (unref(can)("maintenance.logs.delete")) _push(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-3ad82f84${_scopeId}>Delete</button>`);
						else _push(`<!---->`);
					} else return [
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-3ad82f84${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-3ad82f84${_scopeId}>Save</button>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" disabled data-v-3ad82f84${_scopeId}>Select asset</option><!--[-->`);
									ssrRenderList(props.assets, (a) => {
										_push(`<option${ssrRenderAttr("value", a.id)} data-v-3ad82f84${_scopeId}>${ssrInterpolate(a.name)} (${ssrInterpolate(a.asset_code)})</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(`<div class="form-grid-2" data-v-3ad82f84${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<!--[-->`);
									ssrRenderList(props.types, (t) => {
										_push(`<option${ssrRenderAttr("value", t)} data-v-3ad82f84${_scopeId}>${ssrInterpolate(titleize(t))}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<!--[-->`);
									ssrRenderList(props.statuses, (s) => {
										_push(`<option${ssrRenderAttr("value", s)} data-v-3ad82f84${_scopeId}>${ssrInterpolate(statusLabel(s))}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" data-v-3ad82f84${_scopeId}>— None —</option><!--[-->`);
									ssrRenderList(props.vendors, (v) => {
										_push(`<option${ssrRenderAttr("value", v.id)} data-v-3ad82f84${_scopeId}>${ssrInterpolate(v.name)}</option>`);
									});
									_push(`<!--]-->`);
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-3ad82f84${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(completeForm).processing) ? " disabled" : ""} data-v-3ad82f84${_scopeId}>Mark Completed</button>`);
					else return [createVNode("button", {
						class: "ui-btn ui-btn--ghost",
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<p class="ml__hint" data-v-3ad82f84${_scopeId}>Marking <strong data-v-3ad82f84${_scopeId}>${ssrInterpolate(completeRow.value?.maintenance_number)}</strong> on <strong data-v-3ad82f84${_scopeId}>${ssrInterpolate(completeRow.value?.asset_name)}</strong> as completed. This rolls the asset&#39;s next-service date forward and returns it to active.</p>`);
						_push(ssrRenderComponent(_sfc_main$2, {
...
var MaintenanceLogs_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-3ad82f84"]]);
//#endregion
