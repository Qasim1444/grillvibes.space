...
import { t as AdminLayout_default } from "./AdminLayout-Bp8G38ms.js";
...
var _sfc_main = /*@__PURE__*/ Object.assign({ layout: AdminLayout_default }, {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			if (unref(profileForm).recentlySuccessful) _push(`<div class="ui-alert ui-alert--success" data-v-03c5170a> Profile updated successfully. </div>`);
			else _push(`<!---->`);
			...
			if (unref(passwordForm).recentlySuccessful) _push(`<div class="ui-alert ui-alert--success" data-v-03c5170a> Password changed successfully. </div>`);
			else _push(`<!---->`);
			_push(ssrRenderComponent(_sfc_main$2, {
...
var Profile_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-03c5170a"]]);
//#endregion
