...
var _sfc_main = /*@__PURE__*/ Object.assign({ layout: AdminLayout_default }, {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-e6df504f>`);
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("crm.discounts.create")) _push(`<button class="ui-btn ui-btn--primary" data-v-e6df504f${_scopeId}> + Add Campaign </button>`);
						else _push(`<!---->`);
			...
			if (flashError.value) _push(`<div class="ui-alert ui-alert--danger" data-v-e6df504f>${ssrInterpolate(flashError.value)}</div>`);
			else _push(`<!---->`);
			_push(`<div class="stat-grid" data-v-e6df504f>`);
			...
			_push(`</div><div class="dc__filters" data-v-e6df504f>`);
			_push(ssrRenderComponent(_sfc_main$2, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<option value="" data-v-e6df504f${_scopeId}>All statuses</option><option value="active" data-v-e6df504f${_scopeId}>Active</option><option value="inactive" data-v-e6df504f${_scopeId}>Inactive</option><option value="expired" data-v-e6df504f${_scopeId}>Expired</option>`);
					else return [
			...
			_push(ssrRenderComponent(DataTable_default, {
				...
				"cell:name": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) _push(`<div class="dc__name" data-v-e6df504f${_scopeId}><strong data-v-e6df504f${_scopeId}>${ssrInterpolate(row.name)}</strong><span class="dc__meta" data-v-e6df504f${_scopeId}>priority ${ssrInterpolate(row.priority)}</span></div>`);
				...
				"cell:value": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<span data-v-e6df504f${_scopeId}>${ssrInterpolate(row.type === "percentage" ? `${row.value}%` : money(row.value))}</span>`);
						if (row.max_discount) _push(`<span class="dc__meta" data-v-e6df504f${_scopeId}>max ${ssrInterpolate(money(row.max_discount))}</span>`);
						else _push(`<!---->`);
				...
				"cell:scope": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="dc__scope" data-v-e6df504f${_scopeId}><span class="ui-badge ui-badge--muted" data-v-e6df504f${_scopeId}>${ssrInterpolate(scopeLabel(row.applies_to))}</span>`);
						if (row.target_labels.length) _push(`<span class="dc__meta" data-v-e6df504f${_scopeId}>${ssrInterpolate(row.target_labels.join(", "))}</span>`);
						else _push(`<!---->`);
						_push(`</div>`);
				...
				"cell:window": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="dc__meta" data-v-e6df504f${_scopeId}>${ssrInterpolate(row.starts_at || "—")} → ${ssrInterpolate(row.ends_at || "no end")}</span>`);
				...
				"cell:is_live": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="${ssrRenderClass([row.is_live ? "ui-badge--success" : "ui-badge--muted", "ui-badge"])}" data-v-e6df504f${_scopeId}>${ssrInterpolate(row.is_live ? "Live" : row.is_active ? "Out of window" : "Off")}</span>`);
				...
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("crm.discounts.update")) _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-e6df504f${_scopeId}> Edit </button>`);
						else _push(`<!---->`);
						if (unref(can)("crm.discounts.delete")) _push(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-e6df504f${_scopeId}> Delete </button>`);
						else _push(`<!---->`);
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-e6df504f${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-e6df504f${_scopeId}>Save</button>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="dc__grid" data-v-e6df504f${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$2, {
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`<option${ssrRenderAttr("value", true)} data-v-e6df504f${_scopeId}>Active</option><option${ssrRenderAttr("value", false)} data-v-e6df504f${_scopeId}>Inactive</option>`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`<option value="fixed" data-v-e6df504f${_scopeId}>Fixed amount</option><option value="percentage" data-v-e6df504f${_scopeId}>Percentage</option>`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`<option value="all" data-v-e6df504f${_scopeId}>Whole order</option><option value="category" data-v-e6df504f${_scopeId}>Selected categories</option><option value="item" data-v-e6df504f${_scopeId}>Selected items</option>`);
								else return [
						...
						if (unref(form).applies_to !== "all") {
							_push(`<div class="dc__picker" data-v-e6df504f${_scopeId}><span class="ui-label" data-v-e6df504f${_scopeId}>${ssrInterpolate(unref(form).applies_to === "category" ? "Categories" : "Food items")}</span><div class="dc__chips" data-v-e6df504f${_scopeId}><!--[-->`);
							ssrRenderList(targets.value, (t) => {
								_push(`<label class="${ssrRenderClass([{ "dc__chip--on": isTarget(t.id) }, "dc__chip"])}" data-v-e6df504f${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(isTarget(t.id)) ? " checked" : ""} data-v-e6df504f${_scopeId}> ${ssrInterpolate(t.name)}</label>`);
							});
							_push(`<!--]--></div>`);
							if (unref(form).errors.target_ids) _push(`<p class="ui-field__error" data-v-e6df504f${_scopeId}>${ssrInterpolate(unref(form).errors.target_ids)}</p>`);
							else _push(`<!---->`);
							_push(`</div>`);
						} else _push(`<!---->`);
						_push(`<div class="dc__picker" data-v-e6df504f${_scopeId}><span class="ui-label" data-v-e6df504f${_scopeId}>Order types (none ticked = all)</span><div class="dc__chips" data-v-e6df504f${_scopeId}><!--[-->`);
						ssrRenderList(props.orderTypes, (t) => {
							_push(`<label class="${ssrRenderClass([{ "dc__chip--on": unref(form).order_types.includes(t) }, "dc__chip"])}" data-v-e6df504f${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(unref(form).order_types.includes(t)) ? " checked" : ""} data-v-e6df504f${_scopeId}> ${ssrInterpolate(label(t))}</label>`);
						});
						_push(`<!--]--></div>`);
						if (unref(form).errors.order_types) _push(`<p class="ui-field__error" data-v-e6df504f${_scopeId}>${ssrInterpolate(unref(form).errors.order_types)}</p>`);
						else _push(`<!---->`);
						_push(`</div><p class="dc__note" data-v-e6df504f${_scopeId}> A campaign never rewrites a bill on its own — the cashier confirms it in POS, so the order&#39;s discount stays an explicit decision. </p>`);
					} else return [
...
var Discounts_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-e6df504f"]]);
//#endregion
