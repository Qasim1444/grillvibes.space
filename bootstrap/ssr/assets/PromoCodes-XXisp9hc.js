...
var _sfc_main = /*@__PURE__*/ Object.assign({ layout: AdminLayout_default }, {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-04077f65>`);
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("crm.promo-codes.create")) _push(`<button class="ui-btn ui-btn--primary" data-v-04077f65${_scopeId}> + Add Promo Code </button>`);
						else _push(`<!---->`);
			...
			if (flashError.value) _push(`<div class="ui-alert ui-alert--danger" data-v-04077f65>${ssrInterpolate(flashError.value)}</div>`);
			else _push(`<!---->`);
			_push(`<div class="stat-grid" data-v-04077f65>`);
			...
			_push(`</div><div class="pc__filters" data-v-04077f65>`);
			_push(ssrRenderComponent(_sfc_main$2, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<option value="" data-v-04077f65${_scopeId}>All statuses</option><option value="active" data-v-04077f65${_scopeId}>Active</option><option value="inactive" data-v-04077f65${_scopeId}>Inactive</option><option value="expired" data-v-04077f65${_scopeId}>Expired</option>`);
					else return [
			...
			_push(ssrRenderComponent(DataTable_default, {
				...
				"cell:code": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="pc__code" data-v-04077f65${_scopeId}><strong data-v-04077f65${_scopeId}>${ssrInterpolate(row.code)}</strong>`);
						if (row.description) _push(`<span class="pc__desc" data-v-04077f65${_scopeId}>${ssrInterpolate(row.description)}</span>`);
						else _push(`<!---->`);
						_push(`</div>`);
				...
				"cell:value": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<span data-v-04077f65${_scopeId}>${ssrInterpolate(row.type === "percentage" ? `${row.value}%` : money(row.value))}</span>`);
						if (row.max_discount) _push(`<span class="pc__cap" data-v-04077f65${_scopeId}>max ${ssrInterpolate(money(row.max_discount))}</span>`);
						else _push(`<!---->`);
				...
				"cell:window": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="pc__window" data-v-04077f65${_scopeId}>${ssrInterpolate(row.starts_at || "—")} → ${ssrInterpolate(row.ends_at || "no end")}</span>`);
				...
				"cell:usage": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="pc__usage" data-v-04077f65${_scopeId}><span data-v-04077f65${_scopeId}>${ssrInterpolate(row.used_count)}${ssrInterpolate(row.usage_limit ? ` / ${row.usage_limit}` : "")}</span>`);
						if (row.usage_limit_per_customer) _push(`<span class="pc__cap" data-v-04077f65${_scopeId}>${ssrInterpolate(row.usage_limit_per_customer)} per customer </span>`);
						else _push(`<!---->`);
						_push(`</div>`);
				...
				"cell:state": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="${ssrRenderClass([stateClass(value), "ui-badge"])}" data-v-04077f65${_scopeId}>${ssrInterpolate(label(value))}</span>`);
				...
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("crm.promo-codes.update")) _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-04077f65${_scopeId}> Edit </button>`);
						else _push(`<!---->`);
						if (unref(can)("crm.promo-codes.delete")) _push(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-04077f65${_scopeId}> Delete </button>`);
						else _push(`<!---->`);
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-04077f65${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-04077f65${_scopeId}>Save</button>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="pc__grid" data-v-04077f65${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$2, {
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`<option${ssrRenderAttr("value", true)} data-v-04077f65${_scopeId}>Active</option><option${ssrRenderAttr("value", false)} data-v-04077f65${_scopeId}>Inactive</option>`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`<option value="fixed" data-v-04077f65${_scopeId}>Fixed amount</option><option value="percentage" data-v-04077f65${_scopeId}>Percentage</option>`);
						...
						_push(`</div>`);
						if (unref(form).usage_limit_per_customer) _push(`<p class="pc__note" data-v-04077f65${_scopeId}> A per-customer limit needs a customer on the order, so the cashier must pick one before the code applies. </p>`);
						else _push(`<!---->`);
					} else return [
...
var PromoCodes_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-04077f65"]]);
//#endregion
