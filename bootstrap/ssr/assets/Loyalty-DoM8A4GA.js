...
var _sfc_main = /*@__PURE__*/ Object.assign({ layout: AdminLayout_default }, {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-e91273fb>`);
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("crm.loyalty.update")) _push(`<button class="ui-btn ui-btn--ghost" data-v-e91273fb${_scopeId}> Adjust Points </button>`);
						else _push(`<!---->`);
						if (unref(can)("crm.loyalty.update")) _push(`<button class="ui-btn ui-btn--primary" data-v-e91273fb${_scopeId}> Run Expiry Sweep </button>`);
						else _push(`<!---->`);
			...
			if (flashError.value) _push(`<div class="ui-alert ui-alert--danger" data-v-e91273fb>${ssrInterpolate(flashError.value)}</div>`);
			else _push(`<!---->`);
			_push(`<div class="stat-grid" data-v-e91273fb>`);
			...
			_push(`</div><div class="ly__split" data-v-e91273fb><div class="ui-card ly__settings" data-v-e91273fb><h3 class="ly__title" data-v-e91273fb>Programme Settings</h3>`);
			_push(ssrRenderComponent(_sfc_main$2, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<option${ssrRenderAttr("value", true)} data-v-e91273fb${_scopeId}>Running</option><option${ssrRenderAttr("value", false)} data-v-e91273fb${_scopeId}>Paused</option>`);
					else return [createVNode("option", { value: true }, "Running"), createVNode("option", { value: false }, "Paused")];
				}),
				_: 1
			}, _parent));
			_push(`<div class="ly__grid" data-v-e91273fb>`);
			_push(ssrRenderComponent(_sfc_main$2, {
			...
			_push(`</div><p class="ly__note" data-v-e91273fb> At these rates Rs 1,000 spent earns <strong data-v-e91273fb>${ssrInterpolate(num(earnExample.value))}</strong> point(s), worth <strong data-v-e91273fb>${ssrInterpolate(money(worthExample.value))}</strong> back. </p>`);
			if (unref(can)("crm.loyalty.update")) _push(`<button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(sForm).processing) ? " disabled" : ""} data-v-e91273fb> Save Settings </button>`);
			else _push(`<!---->`);
			_push(`</div><div class="ui-card ly__top" data-v-e91273fb><h3 class="ly__title" data-v-e91273fb>Top Balances</h3>`);
			if (props.topCustomers.length) {
				_push(`<table class="ly__table" data-v-e91273fb><thead data-v-e91273fb><tr data-v-e91273fb><th data-v-e91273fb>Customer</th><th class="ly__right" data-v-e91273fb>Points</th></tr></thead><tbody data-v-e91273fb><!--[-->`);
				ssrRenderList(props.topCustomers, (c) => {
					_push(`<tr data-v-e91273fb><td data-v-e91273fb><strong data-v-e91273fb>${ssrInterpolate(c.name)}</strong>`);
					if (c.contact) _push(`<span class="ly__meta" data-v-e91273fb>${ssrInterpolate(c.contact)}</span>`);
					else _push(`<!---->`);
					_push(`</td><td class="ly__right" data-v-e91273fb>${ssrInterpolate(num(c.balance))}</td></tr>`);
				});
				_push(`<!--]--></tbody></table>`);
			} else _push(`<p class="ly__note" data-v-e91273fb>No customer holds points yet.</p>`);
			_push(`</div></div><div class="ly__filters" data-v-e91273fb>`);
			_push(ssrRenderComponent(_sfc_main$2, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<option value="" data-v-e91273fb${_scopeId}>All entries</option><!--[-->`);
						ssrRenderList(props.types, (t) => {
							_push(`<option${ssrRenderAttr("value", t)} data-v-e91273fb${_scopeId}>${ssrInterpolate(label(t))}</option>`);
						});
						_push(`<!--]-->`);
			...
			_push(ssrRenderComponent(DataTable_default, {
				...
				"cell:customer_name": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) _push(`<strong data-v-e91273fb${_scopeId}>${ssrInterpolate(row.customer_name ?? "—")}</strong>`);
					else return [createVNode("strong", null, toDisplayString(row.customer_name ?? "—"), 1)];
				}),
				"cell:type": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="${ssrRenderClass([typeClass(value), "ui-badge"])}" data-v-e91273fb${_scopeId}>${ssrInterpolate(label(value))}</span>`);
				...
				"cell:points": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<strong class="${ssrRenderClass(Number(value) < 0 ? "ly__neg" : "ly__pos")}" data-v-e91273fb${_scopeId}>${ssrInterpolate(Number(value) > 0 ? "+" : "")}${ssrInterpolate(num(value))}</strong>`);
				...
				"cell:note": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<span class="ly__wrap" data-v-e91273fb${_scopeId}>${ssrInterpolate(row.note || "—")}</span>`);
						if (row.created_by_name) _push(`<span class="ly__meta" data-v-e91273fb${_scopeId}>by ${ssrInterpolate(row.created_by_name)}</span>`);
						else _push(`<!---->`);
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-e91273fb${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(aForm).processing) ? " disabled" : ""} data-v-e91273fb${_scopeId}>Save</button>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<p class="ly__note" data-v-e91273fb${_scopeId}> The ledger is never edited — a correction is its own entry, so the history of what was awarded stays intact. </p>`);
					} else return [
...
var Loyalty_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-e91273fb"]]);
//#endregion
