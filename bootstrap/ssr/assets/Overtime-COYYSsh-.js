		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("hr.overtime.create")) _push(`<button class="ui-btn ui-btn--primary" data-v-29880948${_scopeId}> + Log Overtime </button>`);
						else _push(`<!---->`);
			...
			if (flashError.value) _push(`<div class="ui-alert ui-alert--danger" data-v-29880948>${ssrInterpolate(flashError.value)}</div>`);
			else _push(`<!---->`);
			...
			_push(ssrRenderComponent(_sfc_main$2, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<option value="" data-v-29880948${_scopeId}>All statuses</option><option value="pending" data-v-29880948${_scopeId}>Pending</option><option value="approved" data-v-29880948${_scopeId}>Approved</option><option value="rejected" data-v-29880948${_scopeId}>Rejected</option>`);
					else return [
			...
			_push(ssrRenderComponent(DataTable_default, {
				...
				"cell:employee_name": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="ot__name" data-v-29880948${_scopeId}><strong data-v-29880948${_scopeId}>${ssrInterpolate(row.employee_name)}</strong>`);
						if (row.employee_code) _push(`<span class="ot__code" data-v-29880948${_scopeId}>${ssrInterpolate(row.employee_code)}</span>`);
						else _push(`<!---->`);
						_push(`</div>`);
				...
				"cell:amount": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<strong data-v-29880948${_scopeId}>${ssrInterpolate(money(value))}</strong>`);
					else return [createVNode("strong", null, toDisplayString(money(value)), 1)];
				}),
				"cell:status": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<span class="${ssrRenderClass([badgeClass(row.status), "ui-badge"])}" data-v-29880948${_scopeId}>${ssrInterpolate(label(row.status))}</span>`);
						if (row.approver_name) _push(`<span class="ot__by" data-v-29880948${_scopeId}>by ${ssrInterpolate(row.approver_name)}</span>`);
						else _push(`<!---->`);
				...
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("hr.overtime.approve")) {
							_push(`<!--[-->`);
							if (row.status !== "approved") _push(`<button class="ui-btn ui-btn--success ui-btn--sm" data-v-29880948${_scopeId}> Approve </button>`);
							else _push(`<!---->`);
							if (row.status !== "rejected") _push(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-29880948${_scopeId}> Reject </button>`);
							else _push(`<!---->`);
							if (row.status !== "pending") _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-29880948${_scopeId}> Reset </button>`);
							else _push(`<!---->`);
							_push(`<!--]-->`);
						} else _push(`<!---->`);
						if (unref(can)("hr.overtime.update") && row.status !== "approved") _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-29880948${_scopeId}> Edit </button>`);
						else _push(`<!---->`);
						if (unref(can)("hr.overtime.delete") && row.status !== "approved") _push(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-29880948${_scopeId}> Delete </button>`);
						else _push(`<!---->`);
					} else return [
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-29880948${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-29880948${_scopeId}>Save</button>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" data-v-29880948${_scopeId}>— select —</option><!--[-->`);
									ssrRenderList(props.employees, (e) => {
										_push(`<option${ssrRenderAttr("value", e.id)} data-v-29880948${_scopeId}>${ssrInterpolate(e.name)}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(`<div class="ot__grid" data-v-29880948${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$2, {
						...
						_push(`</div>`);
						if (suggestedRate.value) _push(`<p class="ot__hint" data-v-29880948${_scopeId}> Suggested rate from basic salary: ${ssrInterpolate(money(suggestedRate.value))}/hr <button type="button" class="ot__link" data-v-29880948${_scopeId}>use this</button></p>`);
						else _push(`<!---->`);
						_push(ssrRenderComponent(_sfc_main$2, {
...
var Overtime_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-29880948"]]);
//#endregion
