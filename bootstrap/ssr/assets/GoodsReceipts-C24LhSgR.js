...
var _sfc_main = /*@__PURE__*/ Object.assign({ layout: AdminLayout_default }, {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-ee0a5fd7>`);
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						if (unref(can)("procurement.goods-receipts.create")) _push(`<button class="ui-btn ui-btn--primary" data-v-ee0a5fd7${_scopeId}> + Book Delivery </button>`);
						else _push(`<!---->`);
			...
			_push(`<div class="gr__kpis" data-v-ee0a5fd7><div class="gr__kpi gr__kpi--ok" data-v-ee0a5fd7><span class="gr__kpi-label" data-v-ee0a5fd7>Received This Month</span><span class="gr__kpi-val" data-v-ee0a5fd7>${ssrInterpolate(fmt(props.summary.spend_this_month))}</span><span class="gr__kpi-sub" data-v-ee0a5fd7>${ssrInterpolate(props.summary.this_month)} delivery(s)</span></div><div class="gr__kpi gr__kpi--info" data-v-ee0a5fd7><span class="gr__kpi-label" data-v-ee0a5fd7>Awaiting Delivery</span><span class="gr__kpi-val" data-v-ee0a5fd7>${ssrInterpolate(props.summary.awaiting_delivery)}</span><span class="gr__kpi-sub" data-v-ee0a5fd7>purchase orders still open</span></div><div class="${ssrRenderClass([props.summary.ad_hoc_this_month > 0 ? "gr__kpi--warn" : "gr__kpi--muted", "gr__kpi"])}" data-v-ee0a5fd7><span class="gr__kpi-label" data-v-ee0a5fd7>Ad Hoc This Month</span><span class="gr__kpi-val" data-v-ee0a5fd7>${ssrInterpolate(props.summary.ad_hoc_this_month)}</span><span class="gr__kpi-sub" data-v-ee0a5fd7>booked with no purchase order</span></div></div>`);
			if (props.openOrders.length) {
				_push(`<section class="gr__open" data-v-ee0a5fd7><h3 class="gr__open-title" data-v-ee0a5fd7>Expected Deliveries</h3><div class="gr__open-grid" data-v-ee0a5fd7><!--[-->`);
				ssrRenderList(props.openOrders, (order) => {
					_push(`<article class="${ssrRenderClass([{ "gr__card--late": order.is_overdue }, "gr__card"])}" data-v-ee0a5fd7><header class="gr__card-head" data-v-ee0a5fd7><strong data-v-ee0a5fd7>${ssrInterpolate(order.po_number)}</strong>`);
					if (order.is_overdue) _push(`<span class="ui-badge ui-badge--danger" data-v-ee0a5fd7>Overdue</span>`);
					else _push(`<span class="ui-badge ui-badge--info" data-v-ee0a5fd7>Expected ${ssrInterpolate(fmtDate(order.expected_at))}</span>`);
					_push(`</header><p class="gr__card-vendor" data-v-ee0a5fd7>${ssrInterpolate(order.vendor_name)}</p><p class="gr__card-lines" data-v-ee0a5fd7>${ssrInterpolate(order.lines.length)} line(s) outstanding · ${ssrInterpolate(fmt(outstandingValue(order)))}</p>`);
					if (unref(can)("procurement.goods-receipts.create")) _push(`<footer class="gr__card-foot" data-v-ee0a5fd7><button class="ui-btn ui-btn--primary ui-btn--sm" data-v-ee0a5fd7>Book Delivery</button><button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-ee0a5fd7>Receive In Full</button></footer>`);
					else _push(`<!---->`);
					_push(`</article>`);
				});
				_push(`<!--]--></div></section>`);
			} else _push(`<!---->`);
			_push(`<div class="gr__filters" data-v-ee0a5fd7><input${ssrRenderAttr("value", search.value)} class="ui-input gr__search" placeholder="Search GRN / invoice / vendor…" data-v-ee0a5fd7><select class="ui-input" style="${ssrRenderStyle({ "width": "210px" })}" data-v-ee0a5fd7><option value="" data-v-ee0a5fd7${ssrIncludeBooleanAttr(Array.isArray(vendorFilter.value) ? ssrLooseContain(vendorFilter.value, "") : ssrLooseEqual(vendorFilter.value, "")) ? " selected" : ""}>All Vendors</option><!--[-->`);
			ssrRenderList(props.vendors, (v) => {
				_push(`<option${ssrRenderAttr("value", v.id)} data-v-ee0a5fd7${ssrIncludeBooleanAttr(Array.isArray(vendorFilter.value) ? ssrLooseContain(vendorFilter.value, v.id) : ssrLooseEqual(vendorFilter.value, v.id)) ? " selected" : ""}>${ssrInterpolate(v.name)}</option>`);
			});
			_push(`<!--]--></select></div>`);
			_push(ssrRenderComponent(DataTable_default, {
				...
				"cell:grn_number": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) _push(`<strong data-v-ee0a5fd7${_scopeId}>${ssrInterpolate(row.grn_number)}</strong><span class="gr__sub" data-v-ee0a5fd7${_scopeId}>${ssrInterpolate(row.line_count)} line(s)</span>`);
				...
				"cell:vendor_name": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						...
						if (row.created_by_name) _push(`<span class="gr__sub" data-v-ee0a5fd7${_scopeId}>by ${ssrInterpolate(row.created_by_name)}</span>`);
						else _push(`<!---->`);
				...
				"cell:po_number": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) {
						if (value) _push(`<span data-v-ee0a5fd7${_scopeId}>${ssrInterpolate(value)}</span>`);
						else _push(`<span class="ui-badge ui-badge--muted" data-v-ee0a5fd7${_scopeId}>Ad hoc</span>`);
				...
				"cell:invoice_number": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) {
						if (value) _push(`<span data-v-ee0a5fd7${_scopeId}>${ssrInterpolate(value)}</span>`);
						else _push(`<span class="gr__muted" data-v-ee0a5fd7${_scopeId}>—</span>`);
					} else return [value ? (openBlock(), createBlock("span", { key: 0 }, toDisplayString(value), 1)) : (openBlock(), createBlock("span", {
						key: 1,
						class: "gr__muted"
					}, "—"))];
				...
				"cell:total": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<strong data-v-ee0a5fd7${_scopeId}>${ssrInterpolate(fmt(value))}</strong>`);
					else return [createVNode("strong", null, toDisplayString(fmt(value)), 1)];
				}),
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-ee0a5fd7${_scopeId}>View</button>`);
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-ee0a5fd7${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(form).processing || hasDuplicates.value || !validLines.value.length) ? " disabled" : ""} data-v-ee0a5fd7${_scopeId}> Post Receipt </button>`);
					else return [createVNode("button", {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" data-v-ee0a5fd7${_scopeId}>No purchase order (ad hoc / cash purchase)</option><!--[-->`);
									ssrRenderList(props.openOrders, (o) => {
										_push(`<option${ssrRenderAttr("value", o.id)} data-v-ee0a5fd7${_scopeId}>${ssrInterpolate(o.po_number)} — ${ssrInterpolate(o.vendor_name)}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(`<div class="form-grid-2" data-v-ee0a5fd7${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" data-v-ee0a5fd7${_scopeId}>Select a vendor…</option><!--[-->`);
									ssrRenderList(props.vendors, (v) => {
										_push(`<option${ssrRenderAttr("value", v.id)} data-v-ee0a5fd7${_scopeId}>${ssrInterpolate(v.name)}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(`</div><table class="gr__table" data-v-ee0a5fd7${_scopeId}><thead data-v-ee0a5fd7${_scopeId}><tr data-v-ee0a5fd7${_scopeId}><th style="${ssrRenderStyle({ "width": "32%" })}" data-v-ee0a5fd7${_scopeId}>Ingredient</th><th style="${ssrRenderStyle({ "width": "12%" })}" class="gr__right" data-v-ee0a5fd7${_scopeId}>Ordered</th><th style="${ssrRenderStyle({ "width": "18%" })}" data-v-ee0a5fd7${_scopeId}>Received Qty</th><th style="${ssrRenderStyle({ "width": "18%" })}" data-v-ee0a5fd7${_scopeId}>Unit Cost</th><th class="gr__right" data-v-ee0a5fd7${_scopeId}>Line Total</th><th style="${ssrRenderStyle({ "width": "40px" })}" data-v-ee0a5fd7${_scopeId}></th></tr></thead><tbody data-v-ee0a5fd7${_scopeId}>`);
						if (!unref(form).lines.length) _push(`<tr data-v-ee0a5fd7${_scopeId}><td colspan="6" class="gr__muted gr__empty" data-v-ee0a5fd7${_scopeId}> Pick a purchase order above to pre-fill its outstanding lines, or add lines by hand. </td></tr>`);
						else _push(`<!---->`);
						_push(`<!--[-->`);
						ssrRenderList(unref(form).lines, (line, i) => {
							_push(`<tr data-v-ee0a5fd7${_scopeId}><td data-v-ee0a5fd7${_scopeId}><select class="ui-input"${ssrIncludeBooleanAttr(!!line.purchase_order_item_id) ? " disabled" : ""} data-v-ee0a5fd7${_scopeId}><option value="" data-v-ee0a5fd7${ssrIncludeBooleanAttr(Array.isArray(line.ingredient_id) ? ssrLooseContain(line.ingredient_id, "") : ssrLooseEqual(line.ingredient_id, "")) ? " selected" : ""}${_scopeId}>Select…</option><!--[-->`);
							ssrRenderList(props.ingredients, (ing) => {
								_push(`<option${ssrRenderAttr("value", ing.id)} data-v-ee0a5fd7${ssrIncludeBooleanAttr(Array.isArray(line.ingredient_id) ? ssrLooseContain(line.ingredient_id, ing.id) : ssrLooseEqual(line.ingredient_id, ing.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(ing.name)}</option>`);
							});
							_push(`<!--]--></select>`);
							if (isDuplicate(line, i)) _push(`<span class="gr__err" data-v-ee0a5fd7${_scopeId}>Already listed above</span>`);
							else _push(`<!---->`);
							_push(`</td><td class="gr__right gr__muted" data-v-ee0a5fd7${_scopeId}>`);
							if (line.ordered_qty !== void 0) _push(`<!--[-->${ssrInterpolate(qty(line.ordered_qty))}<!--]-->`);
							else _push(`<!--[-->—<!--]-->`);
							_push(`</td><td data-v-ee0a5fd7${_scopeId}><div class="gr__qty" data-v-ee0a5fd7${_scopeId}><input${ssrRenderAttr("value", line.quantity)} type="number" step="0.0001" min="0" class="ui-input" data-v-ee0a5fd7${_scopeId}><span class="gr__unit" data-v-ee0a5fd7${_scopeId}>${ssrInterpolate(unitOf(line.ingredient_id))}</span></div>`);
							if (isShort(line)) _push(`<span class="gr__short" data-v-ee0a5fd7${_scopeId}>short by ${ssrInterpolate(qty(shortfall(line)))}</span>`);
							else if (isOver(line)) _push(`<span class="gr__over" data-v-ee0a5fd7${_scopeId}>over by ${ssrInterpolate(qty(-shortfall(line)))}</span>`);
							else _push(`<!---->`);
							_push(`</td><td data-v-ee0a5fd7${_scopeId}><input${ssrRenderAttr("value", line.unit_cost)} type="number" step="0.01" min="0" class="ui-input" data-v-ee0a5fd7${_scopeId}></td><td class="gr__right" data-v-ee0a5fd7${_scopeId}><strong data-v-ee0a5fd7${_scopeId}>${ssrInterpolate(fmt(lineTotal(line)))}</strong></td><td data-v-ee0a5fd7${_scopeId}><button class="ui-btn ui-btn--danger ui-btn--sm" title="Remove line" data-v-ee0a5fd7${_scopeId}>×</button></td></tr>`);
						});
						_push(`<!--]--></tbody>`);
						if (unref(form).lines.length) _push(`<tfoot data-v-ee0a5fd7${_scopeId}><tr data-v-ee0a5fd7${_scopeId}><td colspan="4" class="gr__right" data-v-ee0a5fd7${_scopeId}><strong data-v-ee0a5fd7${_scopeId}>Delivery Total</strong></td><td class="gr__right" data-v-ee0a5fd7${_scopeId}><strong data-v-ee0a5fd7${_scopeId}>${ssrInterpolate(fmt(deliveryTotal.value))}</strong></td><td data-v-ee0a5fd7${_scopeId}></td></tr></tfoot>`);
						else _push(`<!---->`);
						_push(`</table>`);
						if (unref(form).errors.lines) _push(`<p class="gr__err" data-v-ee0a5fd7${_scopeId}>${ssrInterpolate(unref(form).errors.lines)}</p>`);
						else _push(`<!---->`);
						_push(`<button class="ui-btn ui-btn--secondary ui-btn--sm gr__add" data-v-ee0a5fd7${_scopeId}>+ Add Line</button>`);
						_push(ssrRenderComponent(_sfc_main$2, {
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-ee0a5fd7${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(fullForm).processing) ? " disabled" : ""} data-v-ee0a5fd7${_scopeId}>Post Receipt</button>`);
					else return [createVNode("button", {
						class: "ui-btn ui-btn--ghost",
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<p class="gr__hint" data-v-ee0a5fd7${_scopeId}> Books every outstanding line on ${ssrInterpolate(fullOrder.value?.po_number)} at the prices agreed on the order. Use &quot;Book Delivery&quot; instead if the quantities or the invoice differ. </p><div class="form-grid-2" data-v-ee0a5fd7${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$2, {
						...
						_push(`</div>`);
						if (fullOrder.value) {
							_push(`<table class="gr__table" data-v-ee0a5fd7${_scopeId}><thead data-v-ee0a5fd7${_scopeId}><tr data-v-ee0a5fd7${_scopeId}><th data-v-ee0a5fd7${_scopeId}>Ingredient</th><th class="gr__right" data-v-ee0a5fd7${_scopeId}>Quantity</th><th class="gr__right" data-v-ee0a5fd7${_scopeId}>Unit Cost</th><th class="gr__right" data-v-ee0a5fd7${_scopeId}>Line Total</th></tr></thead><tbody data-v-ee0a5fd7${_scopeId}><!--[-->`);
							ssrRenderList(fullOrder.value.lines, (line) => {
								_push(`<tr data-v-ee0a5fd7${_scopeId}><td data-v-ee0a5fd7${_scopeId}>${ssrInterpolate(line.name)}</td><td class="gr__right" data-v-ee0a5fd7${_scopeId}>${ssrInterpolate(qty(line.quantity))} ${ssrInterpolate(line.unit)}</td><td class="gr__right gr__muted" data-v-ee0a5fd7${_scopeId}>${ssrInterpolate(fmt(line.unit_cost))}</td><td class="gr__right" data-v-ee0a5fd7${_scopeId}><strong data-v-ee0a5fd7${_scopeId}>${ssrInterpolate(fmt(line.quantity * line.unit_cost))}</strong></td></tr>`);
							});
							_push(`<!--]--></tbody><tfoot data-v-ee0a5fd7${_scopeId}><tr data-v-ee0a5fd7${_scopeId}><td colspan="3" class="gr__right" data-v-ee0a5fd7${_scopeId}><strong data-v-ee0a5fd7${_scopeId}>Total</strong></td><td class="gr__right" data-v-ee0a5fd7${_scopeId}><strong data-v-ee0a5fd7${_scopeId}>${ssrInterpolate(fmt(outstandingValue(fullOrder.value)))}</strong></td></tr></tfoot></table>`);
						} else _push(`<!---->`);
					} else return [
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-ee0a5fd7${_scopeId}>Close</button>`);
					else return [createVNode("button", {
						class: "ui-btn ui-btn--ghost",
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (viewing.value) {
							_push(`<div data-v-ee0a5fd7${_scopeId}><div class="gr__meta" data-v-ee0a5fd7${_scopeId}><div data-v-ee0a5fd7${_scopeId}><span class="gr__meta-label" data-v-ee0a5fd7${_scopeId}>Vendor</span><span data-v-ee0a5fd7${_scopeId}>${ssrInterpolate(viewing.value.vendor_name || "—")}</span></div><div data-v-ee0a5fd7${_scopeId}><span class="gr__meta-label" data-v-ee0a5fd7${_scopeId}>Purchase Order</span><span data-v-ee0a5fd7${_scopeId}>${ssrInterpolate(viewing.value.po_number || "Ad hoc")}</span></div><div data-v-ee0a5fd7${_scopeId}><span class="gr__meta-label" data-v-ee0a5fd7${_scopeId}>Invoice</span><span data-v-ee0a5fd7${_scopeId}>${ssrInterpolate(viewing.value.invoice_number || "—")}</span></div><div data-v-ee0a5fd7${_scopeId}><span class="gr__meta-label" data-v-ee0a5fd7${_scopeId}>Received</span><span data-v-ee0a5fd7${_scopeId}>${ssrInterpolate(fmtDate(viewing.value.received_at))}</span></div><div data-v-ee0a5fd7${_scopeId}><span class="gr__meta-label" data-v-ee0a5fd7${_scopeId}>Booked By</span><span data-v-ee0a5fd7${_scopeId}>${ssrInterpolate(viewing.value.created_by_name || "—")}</span></div><div data-v-ee0a5fd7${_scopeId}><span class="gr__meta-label" data-v-ee0a5fd7${_scopeId}>Total</span><span data-v-ee0a5fd7${_scopeId}><strong data-v-ee0a5fd7${_scopeId}>${ssrInterpolate(fmt(viewing.value.total))}</strong></span></div></div><table class="gr__table" data-v-ee0a5fd7${_scopeId}><thead data-v-ee0a5fd7${_scopeId}><tr data-v-ee0a5fd7${_scopeId}><th data-v-ee0a5fd7${_scopeId}>Ingredient</th><th class="gr__right" data-v-ee0a5fd7${_scopeId}>Quantity</th><th class="gr__right" data-v-ee0a5fd7${_scopeId}>Unit Cost</th><th class="gr__right" data-v-ee0a5fd7${_scopeId}>Line Total</th></tr></thead><tbody data-v-ee0a5fd7${_scopeId}><!--[-->`);
							ssrRenderList(viewing.value.lines, (line, i) => {
								_push(`<tr data-v-ee0a5fd7${_scopeId}><td data-v-ee0a5fd7${_scopeId}>${ssrInterpolate(line.name)}</td><td class="gr__right" data-v-ee0a5fd7${_scopeId}>${ssrInterpolate(qty(line.quantity))} ${ssrInterpolate(line.unit)}</td><td class="gr__right gr__muted" data-v-ee0a5fd7${_scopeId}>${ssrInterpolate(fmt(line.unit_cost))}</td><td class="gr__right" data-v-ee0a5fd7${_scopeId}><strong data-v-ee0a5fd7${_scopeId}>${ssrInterpolate(fmt(line.line_total))}</strong></td></tr>`);
							});
							_push(`<!--]--></tbody></table>`);
							if (viewing.value.notes) _push(`<p class="gr__notes" data-v-ee0a5fd7${_scopeId}><span class="gr__meta-label" data-v-ee0a5fd7${_scopeId}>Notes</span>${ssrInterpolate(viewing.value.notes)}</p>`);
							else _push(`<!---->`);
							_push(`<p class="gr__hint" data-v-ee0a5fd7${_scopeId}> Posted receipts are permanent — the costs above have already been used to value stock and to cost the orders sold since. Correct a mistake with a stock take or a write-off on the Stock screen. </p></div>`);
						} else _push(`<!---->`);
...
var GoodsReceipts_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-ee0a5fd7"]]);
//#endregion
