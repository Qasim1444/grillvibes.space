...
var _sfc_main = /*@__PURE__*/ Object.assign({ layout: AdminLayout_default }, {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-44a76143>`);
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("hr.employees.create")) _push(`<button class="ui-btn ui-btn--primary" data-v-44a76143${_scopeId}> + Add Employee </button>`);
						else _push(`<!---->`);
			...
			_push(`<div class="stat-grid" data-v-44a76143>`);
			...
			_push(`</div><div class="emp__filters" data-v-44a76143>`);
			_push(ssrRenderComponent(_sfc_main$2, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<option value="" data-v-44a76143${_scopeId}>All statuses</option><!--[-->`);
						ssrRenderList(props.statuses, (s) => {
							_push(`<option${ssrRenderAttr("value", s)} data-v-44a76143${_scopeId}>${ssrInterpolate(label(s))}</option>`);
						});
						_push(`<!--]-->`);
			...
			_push(ssrRenderComponent(DataTable_default, {
				...
				"cell:name": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="emp__name" data-v-44a76143${_scopeId}><strong data-v-44a76143${_scopeId}>${ssrInterpolate(row.name)}</strong>`);
						if (row.employee_code) _push(`<span class="emp__code" data-v-44a76143${_scopeId}>${ssrInterpolate(row.employee_code)}</span>`);
						else _push(`<!---->`);
						_push(`</div>`);
				...
				"cell:employment_status": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="${ssrRenderClass([statusClass(value), "ui-badge"])}" data-v-44a76143${_scopeId}>${ssrInterpolate(label(value))}</span>`);
				...
				"cell:has_login": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="${ssrRenderClass([value ? "ui-badge--info" : "ui-badge--muted", "ui-badge"])}" data-v-44a76143${_scopeId}>${ssrInterpolate(value ? "Yes" : "No")}</span>`);
				...
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("hr.employees.update")) _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-44a76143${_scopeId}> Edit </button>`);
						else _push(`<!---->`);
						if (unref(can)("hr.employees.delete")) _push(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-44a76143${_scopeId}> Delete </button>`);
						else _push(`<!---->`);
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-44a76143${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-44a76143${_scopeId}>Save</button>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="emp__grid" data-v-44a76143${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$2, {
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" data-v-44a76143${_scopeId}>— none —</option><!--[-->`);
									ssrRenderList(props.designations, (d) => {
										_push(`<option${ssrRenderAttr("value", d.id)} data-v-44a76143${_scopeId}>${ssrInterpolate(d.name)}</option>`);
									});
									_push(`<!--]-->`);
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									...
									ssrRenderList(props.places, (p) => {
										_push(`<option${ssrRenderAttr("value", p.id)} data-v-44a76143${_scopeId}>${ssrInterpolate(p.name)}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`<option value="" data-v-44a76143${_scopeId}>— not set —</option><option value="male" data-v-44a76143${_scopeId}>Male</option><option value="female" data-v-44a76143${_scopeId}>Female</option><option value="other" data-v-44a76143${_scopeId}>Other</option>`);
								else return [
						...
						_push(`<div class="emp__login" data-v-44a76143${_scopeId}><p class="emp__login-note" data-v-44a76143${_scopeId}> Login is optional. Leave both fields blank for staff who only need attendance and payroll — they cannot sign in without an email <em data-v-44a76143${_scopeId}>and</em> a password. </p><div class="emp__grid" data-v-44a76143${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$2, {
...
var Employees_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-44a76143"]]);
//#endregion
