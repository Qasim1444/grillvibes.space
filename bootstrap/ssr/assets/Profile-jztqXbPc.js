...
var _sfc_main = /*@__PURE__*/ Object.assign({ layout: AdminLayout_default }, {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-87a3268c>`);
			_push(ssrRenderComponent(_sfc_main$1, {
				title: "Profile",
				subtitle: "Your account information."
			}, null, _parent));
			_push(`<div class="profile-grid" data-v-87a3268c><div class="ui-card ui-card-pad" data-v-87a3268c><h3 class="profile__section-title" data-v-87a3268c>Personal Info</h3>`);
			if (unref(profileForm).recentlySuccessful) _push(`<div class="ui-alert ui-alert--success" data-v-87a3268c> Profile updated successfully. </div>`);
			else _push(`<!---->`);
			...
			if (unref(can)("profile.update")) _push(`<button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(profileForm).processing) ? " disabled" : ""} data-v-87a3268c>${ssrInterpolate(unref(profileForm).processing ? "Saving…" : "Update Profile")}</button>`);
			else _push(`<!---->`);
			_push(`</div>`);
			if (unref(can)("change-password.update")) {
				_push(`<div class="ui-card" data-v-87a3268c><div class="ui-card-header" data-v-87a3268c><span data-v-87a3268c>Change Password</span></div><div class="ui-card-pad" data-v-87a3268c>`);
				if (unref(passwordForm).recentlySuccessful) _push(`<div class="ui-alert ui-alert--success" data-v-87a3268c> Password changed successfully. </div>`);
				else _push(`<!---->`);
				_push(ssrRenderComponent(_sfc_main$2, {
				...
				_push(`<button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(passwordForm).processing) ? " disabled" : ""} data-v-87a3268c>${ssrInterpolate(unref(passwordForm).processing ? "Updating…" : "Change Password")}</button></div></div>`);
			} else _push(`<!---->`);
			_push(`</div></div>`);
		};
	}
...
var Profile_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-87a3268c"]]);
//#endregion
