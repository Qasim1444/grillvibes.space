...
var _sfc_main = /*@__PURE__*/ Object.assign({ layout: AdminLayout_default }, {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-9cecce2d>`);
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (!props.run && unref(can)("hr.payroll.create")) _push(`<button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(generating.value || !previewRows.value.length) ? " disabled" : ""} data-v-9cecce2d${_scopeId}>${ssrInterpolate(generating.value ? "Generating…" : "Generate Draft")}</button>`);
						else _push(`<!---->`);
						if (props.run) {
							_push(`<!--[-->`);
							if (props.run.status === "draft" && unref(can)("hr.payroll.create")) _push(`<button class="ui-btn ui-btn--ghost" data-v-9cecce2d${_scopeId}> Recompute </button>`);
							else _push(`<!---->`);
							if (props.run.status === "draft" && unref(can)("hr.payroll.approve")) _push(`<button class="ui-btn ui-btn--primary" data-v-9cecce2d${_scopeId}> Approve </button>`);
							else _push(`<!---->`);
							if (props.run.status === "approved" && unref(can)("hr.payroll.approve")) _push(`<button class="ui-btn ui-btn--success" data-v-9cecce2d${_scopeId}> Mark Paid </button>`);
							else _push(`<!---->`);
							if (props.run.status === "draft" && unref(can)("hr.payroll.delete")) _push(`<button class="ui-btn ui-btn--danger" data-v-9cecce2d${_scopeId}> Delete Draft </button>`);
							else _push(`<!---->`);
							_push(`<!--]-->`);
						} else _push(`<!---->`);
			...
			if (flashError.value) _push(`<div class="ui-alert ui-alert--danger" data-v-9cecce2d>${ssrInterpolate(flashError.value)}</div>`);
			else _push(`<!---->`);
			if (monthError.value) _push(`<div class="ui-alert ui-alert--danger" data-v-9cecce2d>${ssrInterpolate(monthError.value)}</div>`);
			else _push(`<!---->`);
			_push(`<div class="pr__bar ui-card ui-card-pad" data-v-9cecce2d><div class="pr__month" data-v-9cecce2d><label class="ui-label" for="pr-month" data-v-9cecce2d>Month</label><input id="pr-month" class="ui-input" type="month"${ssrRenderAttr("value", props.month)} data-v-9cecce2d></div><div class="pr__state" data-v-9cecce2d><span class="pr__label" data-v-9cecce2d>${ssrInterpolate(props.monthLabel)}</span>`);
			if (props.run) _push(`<span class="${ssrRenderClass([statusClass(props.run.status), "ui-badge"])}" data-v-9cecce2d>${ssrInterpolate(label(props.run.status))}</span>`);
			else _push(`<span class="ui-badge ui-badge--info" data-v-9cecce2d>Not generated — live preview</span>`);
			_push(`</div>`);
			if (props.run) {
				_push(`<div class="pr__meta" data-v-9cecce2d>`);
				if (props.run.processor_name) _push(`<span data-v-9cecce2d>Processed by ${ssrInterpolate(props.run.processor_name)}</span>`);
				else _push(`<!---->`);
				if (props.run.approved_at) _push(`<span data-v-9cecce2d>Approved ${ssrInterpolate(props.run.approved_at)}</span>`);
				else _push(`<!---->`);
				if (props.run.paid_at) _push(`<span data-v-9cecce2d>Paid ${ssrInterpolate(props.run.paid_at)}</span>`);
				else _push(`<!---->`);
				_push(`</div>`);
			} else _push(`<!---->`);
			_push(`</div><div class="stat-grid" data-v-9cecce2d>`);
			...
			_push(ssrRenderComponent(DataTable_default, {
				...
				"cell:name": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="pr__name" data-v-9cecce2d${_scopeId}><strong data-v-9cecce2d${_scopeId}>${ssrInterpolate(row.name)}</strong>`);
						if (row.employee_code) _push(`<span class="pr__code" data-v-9cecce2d${_scopeId}>${ssrInterpolate(row.employee_code)}</span>`);
						else _push(`<!---->`);
						_push(`</div>`);
				...
				"cell:days": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="pr__days" data-v-9cecce2d${_scopeId}>${ssrInterpolate(row.present_days)} present · ${ssrInterpolate(row.absent_days)} absent · ${ssrInterpolate(row.leave_days)} leave <em data-v-9cecce2d${_scopeId}>of ${ssrInterpolate(row.payable_days)}</em></span>`);
				...
				"cell:net": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<strong data-v-9cecce2d${_scopeId}>${ssrInterpolate(money(value))}</strong>`);
					else return [createVNode("strong", null, toDisplayString(money(value)), 1)];
				}),
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-9cecce2d${_scopeId}>Details</button>`);
			...
			_push(`<div class="pr__section" data-v-9cecce2d><div class="pr__section-head" data-v-9cecce2d><div data-v-9cecce2d><h3 class="pr__h3" data-v-9cecce2d>Deductions</h3><p class="pr__sub" data-v-9cecce2d> Unbilled deductions. Recurring ones are charged every month; one-off rows are consumed the moment a run is approved. </p></div>`);
			if (unref(can)("hr.payroll.create")) _push(`<button class="ui-btn ui-btn--primary ui-btn--sm" data-v-9cecce2d> + Add Deduction </button>`);
			else _push(`<!---->`);
			_push(`</div>`);
			_push(ssrRenderComponent(DataTable_default, {
				...
				"cell:is_recurring": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="${ssrRenderClass([value ? "ui-badge--info" : "ui-badge--muted", "ui-badge"])}" data-v-9cecce2d${_scopeId}>${ssrInterpolate(value ? "Monthly" : "One-off")}</span>`);
				...
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("hr.payroll.create")) _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-9cecce2d${_scopeId}> Edit </button>`);
						else _push(`<!---->`);
						if (unref(can)("hr.payroll.delete")) _push(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-9cecce2d${_scopeId}> Delete </button>`);
						else _push(`<!---->`);
			...
			_push(`</div><div class="pr__section" data-v-9cecce2d><h3 class="pr__h3" data-v-9cecce2d>Run History</h3>`);
			_push(ssrRenderComponent(DataTable_default, {
				columns: runColumns,
				...
				"cell:status": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="${ssrRenderClass([statusClass(value), "ui-badge"])}" data-v-9cecce2d${_scopeId}>${ssrInterpolate(label(value))}</span>`);
				...
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-9cecce2d${_scopeId}>Open</button>`);
					else return [createVNode("button", {
						class: "ui-btn ui-btn--ghost ui-btn--sm",
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-9cecce2d${_scopeId}>Close</button>`);
					else return [createVNode("button", {
						class: "ui-btn ui-btn--ghost",
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (slip.value) {
							_push(`<!--[--><div class="pr__slip-head" data-v-9cecce2d${_scopeId}><div data-v-9cecce2d${_scopeId}><strong data-v-9cecce2d${_scopeId}>${ssrInterpolate(slip.value.name)}</strong>`);
							if (slip.value.employee_code) _push(`<span class="pr__code" data-v-9cecce2d${_scopeId}> · ${ssrInterpolate(slip.value.employee_code)}</span>`);
							else _push(`<!---->`);
							if (slip.value.designation) _push(`<div class="pr__sub" data-v-9cecce2d${_scopeId}>${ssrInterpolate(slip.value.designation)}</div>`);
							else _push(`<!---->`);
							_push(`</div><div class="pr__slip-net" data-v-9cecce2d${_scopeId}><span class="pr__sub" data-v-9cecce2d${_scopeId}>Net pay</span><strong data-v-9cecce2d${_scopeId}>${ssrInterpolate(money(slip.value.net))}</strong></div></div><table class="pr__table" data-v-9cecce2d${_scopeId}><tbody data-v-9cecce2d${_scopeId}><tr data-v-9cecce2d${_scopeId}><td data-v-9cecce2d${_scopeId}>Basic salary (monthly)</td><td data-v-9cecce2d${_scopeId}>${ssrInterpolate(money(snap.value.basic_salary ?? slip.value.basic))}</td></tr><tr data-v-9cecce2d${_scopeId}><td data-v-9cecce2d${_scopeId}>Payable days</td><td data-v-9cecce2d${_scopeId}>${ssrInterpolate(slip.value.payable_days)}</td></tr><tr data-v-9cecce2d${_scopeId}><td data-v-9cecce2d${_scopeId}>Absent / leave deducted</td><td data-v-9cecce2d${_scopeId}>${ssrInterpolate(slip.value.absent_days)} day(s)</td></tr><tr data-v-9cecce2d${_scopeId}><td data-v-9cecce2d${_scopeId}>Earned basic</td><td data-v-9cecce2d${_scopeId}>${ssrInterpolate(money(slip.value.earned_basic ?? slip.value.basic))}</td></tr><tr data-v-9cecce2d${_scopeId}><td data-v-9cecce2d${_scopeId}>Overtime</td><td data-v-9cecce2d${_scopeId}>${ssrInterpolate(money(slip.value.overtime_amount))}</td></tr><tr class="pr__row-strong" data-v-9cecce2d${_scopeId}><td data-v-9cecce2d${_scopeId}>Gross</td><td data-v-9cecce2d${_scopeId}>${ssrInterpolate(money(slip.value.gross))}</td></tr><tr data-v-9cecce2d${_scopeId}><td data-v-9cecce2d${_scopeId}>Deductions</td><td data-v-9cecce2d${_scopeId}>− ${ssrInterpolate(money(slip.value.deductions_amount))}</td></tr><tr data-v-9cecce2d${_scopeId}><td data-v-9cecce2d${_scopeId}>Loan installment</td><td data-v-9cecce2d${_scopeId}>− ${ssrInterpolate(money(slip.value.loan_deduction))}</td></tr><tr class="pr__row-strong" data-v-9cecce2d${_scopeId}><td data-v-9cecce2d${_scopeId}>Net</td><td data-v-9cecce2d${_scopeId}>${ssrInterpolate(money(slip.value.net))}</td></tr></tbody></table>`);
							if (snap.value.overtime?.length) {
								_push(`<div class="pr__block" data-v-9cecce2d${_scopeId}><h4 class="pr__h4" data-v-9cecce2d${_scopeId}>Overtime entries</h4><!--[-->`);
								ssrRenderList(snap.value.overtime, (o, i) => {
									_push(`<p class="pr__line" data-v-9cecce2d${_scopeId}>${ssrInterpolate(o.date)} — ${ssrInterpolate(o.hours)} h × ${ssrInterpolate(money(o.rate_per_hour))} = ${ssrInterpolate(money(o.amount))}</p>`);
								});
								_push(`<!--]--></div>`);
							} else _push(`<!---->`);
							if (snap.value.leaves?.length) {
								_push(`<div class="pr__block" data-v-9cecce2d${_scopeId}><h4 class="pr__h4" data-v-9cecce2d${_scopeId}>Leave</h4><!--[-->`);
								ssrRenderList(snap.value.leaves, (l, i) => {
									_push(`<p class="pr__line" data-v-9cecce2d${_scopeId}>${ssrInterpolate(l.type)} — ${ssrInterpolate(l.from)} → ${ssrInterpolate(l.to)} (${ssrInterpolate(l.days)} day${ssrInterpolate(l.days === 1 ? "" : "s")}, ${ssrInterpolate(l.paid ? "paid" : "unpaid")}) </p>`);
								});
								_push(`<!--]--></div>`);
							} else _push(`<!---->`);
							if (snap.value.deductions?.length) {
								_push(`<div class="pr__block" data-v-9cecce2d${_scopeId}><h4 class="pr__h4" data-v-9cecce2d${_scopeId}>Deductions</h4><!--[-->`);
								ssrRenderList(snap.value.deductions, (d, i) => {
									_push(`<p class="pr__line" data-v-9cecce2d${_scopeId}>${ssrInterpolate(d.title)} — ${ssrInterpolate(money(d.amount))}`);
									if (d.recurring) _push(`<span data-v-9cecce2d${_scopeId}> (monthly)</span>`);
									else _push(`<!---->`);
									_push(`</p>`);
								});
								_push(`<!--]--></div>`);
							...
							if (snap.value.loans?.length) {
								_push(`<div class="pr__block" data-v-9cecce2d${_scopeId}><h4 class="pr__h4" data-v-9cecce2d${_scopeId}>Loan installments</h4><!--[-->`);
								ssrRenderList(snap.value.loans, (l, i) => {
									_push(`<p class="pr__line" data-v-9cecce2d${_scopeId}>${ssrInterpolate(label(l.type))} #${ssrInterpolate(l.loan_id)} — ${ssrInterpolate(money(l.amount))}</p>`);
								});
								_push(`<!--]--></div>`);
							} else _push(`<!---->`);
							if (snap.value.generated_at) _push(`<p class="pr__sub" data-v-9cecce2d${_scopeId}>Computed ${ssrInterpolate(snap.value.generated_at)}</p>`);
							else _push(`<!---->`);
							_push(`<!--]-->`);
						} else _push(`<!---->`);
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-9cecce2d${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(dForm).processing) ? " disabled" : ""} data-v-9cecce2d${_scopeId}>Save</button>`);
					else return [createVNode("button", {
						class: "ui-btn ui-btn--ghost",
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" data-v-9cecce2d${_scopeId}>— select —</option><!--[-->`);
									ssrRenderList(props.employees, (e) => {
										_push(`<option${ssrRenderAttr("value", e.id)} data-v-9cecce2d${_scopeId}>${ssrInterpolate(e.name)}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(`<div class="pr__grid" data-v-9cecce2d${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$2, {
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`<option${ssrRenderAttr("value", false)} data-v-9cecce2d${_scopeId}>One-off</option><option${ssrRenderAttr("value", true)} data-v-9cecce2d${_scopeId}>Every month</option>`);
...
var Payroll_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-9cecce2d"]]);
//#endregion
