...
var _sfc_main = /*@__PURE__*/ Object.assign({ layout: AdminLayout_default }, {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-38ec4fb5>`);
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<a href="/kds/board" target="_blank" class="ui-btn ui-btn--ghost" data-v-38ec4fb5${_scopeId}>🖥 Open Board</a>`);
						if (unref(can)("kds.stations.create")) _push(`<button class="ui-btn ui-btn--primary" data-v-38ec4fb5${_scopeId}>+ Add Station</button>`);
						else _push(`<!---->`);
			...
			_push(ssrRenderComponent(DataTable_default, {
				...
				"cell:color": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="kds-stn__dot" style="${ssrRenderStyle({ background: value })}" data-v-38ec4fb5${_scopeId}></span>`);
				...
				"cell:is_active": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="${ssrRenderClass([value ? "ui-badge--success" : "ui-badge--muted", "ui-badge"])}" data-v-38ec4fb5${_scopeId}>${ssrInterpolate(value ? "Active" : "Inactive")}</span>`);
				...
				"cell:category_ids": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) {
						if (!value || value.length === 0) _push(`<span class="ui-badge ui-badge--muted" data-v-38ec4fb5${_scopeId}>All categories</span>`);
						else {
							_push(`<span class="kds-stn__cats" data-v-38ec4fb5${_scopeId}><!--[-->`);
							ssrRenderList(value, (id) => {
								_push(`<span class="ui-badge ui-badge--info" data-v-38ec4fb5${_scopeId}>${ssrInterpolate(catName(id))}</span>`);
							});
							_push(`<!--]--></span>`);
						}
				...
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("kds.stations.update")) _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-38ec4fb5${_scopeId}>Edit</button>`);
						else _push(`<!---->`);
						if (unref(can)("kds.stations.delete")) _push(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-38ec4fb5${_scopeId}>Delete</button>`);
						else _push(`<!---->`);
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-38ec4fb5${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-38ec4fb5${_scopeId}>Save</button>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="form-grid-2" data-v-38ec4fb5${_scopeId}>`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" data-v-38ec4fb5${_scopeId}>All Branches</option><!--[-->`);
									ssrRenderList(props.branches, (b) => {
										_push(`<option${ssrRenderAttr("value", b.id)} data-v-38ec4fb5${_scopeId}>${ssrInterpolate(b.name)}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(`<div class="ui-field" data-v-38ec4fb5${_scopeId}><label class="ui-label" data-v-38ec4fb5${_scopeId}>Accent Color</label><div class="kds-stn__color-row" data-v-38ec4fb5${_scopeId}><input${ssrRenderAttr("value", unref(form).color)} type="color" class="kds-stn__color-input" data-v-38ec4fb5${_scopeId}><span class="kds-stn__color-val" data-v-38ec4fb5${_scopeId}>${ssrInterpolate(unref(form).color)}</span><span class="kds-stn__preview" style="${ssrRenderStyle({ background: unref(form).color })}" data-v-38ec4fb5${_scopeId}>Preview</span></div></div>`);
						_push(ssrRenderComponent(_sfc_main$2, {
						...
						_push(`<div class="ui-field" data-v-38ec4fb5${_scopeId}><label class="ui-label" data-v-38ec4fb5${_scopeId}>Handles Categories</label><p class="kds-stn__hint" data-v-38ec4fb5${_scopeId}>Leave all unchecked to handle every category.</p><div class="kds-stn__cats-grid" data-v-38ec4fb5${_scopeId}><!--[-->`);
						ssrRenderList(props.categories, (cat) => {
							_push(`<label class="kds-stn__cat-label" data-v-38ec4fb5${_scopeId}><input type="checkbox"${ssrRenderAttr("value", cat.id)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).category_ids) ? ssrLooseContain(unref(form).category_ids, cat.id) : unref(form).category_ids) ? " checked" : ""} data-v-38ec4fb5${_scopeId}><span data-v-38ec4fb5${_scopeId}>${ssrInterpolate(cat.name)}</span></label>`);
						});
						_push(`<!--]--></div></div>`);
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`<option${ssrRenderAttr("value", true)} data-v-38ec4fb5${_scopeId}>Active</option><option${ssrRenderAttr("value", false)} data-v-38ec4fb5${_scopeId}>Inactive</option>`);
...
var Stations_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-38ec4fb5"]]);
//#endregion
