...
var _sfc_main = /*@__PURE__*/ Object.assign({ layout: AdminLayout_default }, {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-55e1adb4>`);
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("petty-cash.create")) _push(`<button class="ui-btn ui-btn--secondary" data-v-55e1adb4${_scopeId}>+ Record Transaction</button>`);
						else _push(`<!---->`);
						if (unref(can)("petty-cash.create")) _push(`<button class="ui-btn ui-btn--primary" data-v-55e1adb4${_scopeId}>+ New Fund</button>`);
						else _push(`<!---->`);
			...
			_push(`<div class="pc__kpis" data-v-55e1adb4><div class="pc__kpi ex__kpi--ok" data-v-55e1adb4><span class="pc__kpi-label" data-v-55e1adb4>Total Balance</span><span class="pc__kpi-val" data-v-55e1adb4>${ssrInterpolate(fmt(props.summary.total_balance))}</span><span class="pc__kpi-sub" data-v-55e1adb4>across active funds</span></div><div class="pc__kpi" data-v-55e1adb4><span class="pc__kpi-label" data-v-55e1adb4>Active Funds</span><span class="pc__kpi-val" data-v-55e1adb4>${ssrInterpolate(props.summary.active_funds)}</span><span class="pc__kpi-sub" data-v-55e1adb4>cash floats</span></div><div class="pc__kpi pc__kpi--danger" data-v-55e1adb4><span class="pc__kpi-label" data-v-55e1adb4>Disbursed (mo.)</span><span class="pc__kpi-val" data-v-55e1adb4>${ssrInterpolate(fmt(props.summary.disbursed_this_month))}</span><span class="pc__kpi-sub" data-v-55e1adb4>paid out this month</span></div><div class="pc__kpi pc__kpi--info" data-v-55e1adb4><span class="pc__kpi-label" data-v-55e1adb4>Topped Up (mo.)</span><span class="pc__kpi-val" data-v-55e1adb4>${ssrInterpolate(fmt(props.summary.topped_up_this_month))}</span><span class="pc__kpi-sub" data-v-55e1adb4>added this month</span></div></div><h2 class="pc__section" data-v-55e1adb4>Cash Floats</h2>`);
			_push(ssrRenderComponent(DataTable_default, {
				...
				"cell:name": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<strong data-v-55e1adb4${_scopeId}>${ssrInterpolate(row.name)}</strong>`);
						if (!row.is_active) _push(`<span class="ui-badge ui-badge--muted pc__pill" data-v-55e1adb4${_scopeId}>Inactive</span>`);
						else _push(`<!---->`);
				...
				"cell:current_balance": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<strong data-v-55e1adb4${_scopeId}>${ssrInterpolate(fmt(value))}</strong>`);
					else return [createVNode("strong", null, toDisplayString(fmt(value)), 1)];
				}),
				"cell:custodian_name": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) {
						if (value) _push(`<span data-v-55e1adb4${_scopeId}>${ssrInterpolate(value)}</span>`);
						else _push(`<span class="pc__muted" data-v-55e1adb4${_scopeId}>—</span>`);
				...
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("petty-cash.create")) _push(`<button class="ui-btn ui-btn--secondary ui-btn--sm" data-v-55e1adb4${_scopeId}>Add Txn</button>`);
						else _push(`<!---->`);
						if (unref(can)("petty-cash.update")) _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-55e1adb4${_scopeId}>Edit</button>`);
						else _push(`<!---->`);
						if (unref(can)("petty-cash.delete")) _push(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-55e1adb4${_scopeId}>Delete</button>`);
						else _push(`<!---->`);
					} else return [
			...
			_push(`<h2 class="pc__section" data-v-55e1adb4>Ledger</h2><div class="pc__filters" data-v-55e1adb4><select class="ui-input" style="${ssrRenderStyle({ "width": "220px" })}" data-v-55e1adb4><option value="" data-v-55e1adb4${ssrIncludeBooleanAttr(Array.isArray(accountFilter.value) ? ssrLooseContain(accountFilter.value, "") : ssrLooseEqual(accountFilter.value, "")) ? " selected" : ""}>All Funds</option><!--[-->`);
			ssrRenderList(props.accounts, (a) => {
				_push(`<option${ssrRenderAttr("value", a.id)} data-v-55e1adb4${ssrIncludeBooleanAttr(Array.isArray(accountFilter.value) ? ssrLooseContain(accountFilter.value, a.id) : ssrLooseEqual(accountFilter.value, a.id)) ? " selected" : ""}>${ssrInterpolate(a.name)}</option>`);
			});
			_push(`<!--]--></select><select class="ui-input" style="${ssrRenderStyle({ "width": "170px" })}" data-v-55e1adb4><option value="" data-v-55e1adb4${ssrIncludeBooleanAttr(Array.isArray(typeFilter.value) ? ssrLooseContain(typeFilter.value, "") : ssrLooseEqual(typeFilter.value, "")) ? " selected" : ""}>All Types</option><!--[-->`);
			ssrRenderList(props.types, (t) => {
				_push(`<option${ssrRenderAttr("value", t)} data-v-55e1adb4${ssrIncludeBooleanAttr(Array.isArray(typeFilter.value) ? ssrLooseContain(typeFilter.value, t) : ssrLooseEqual(typeFilter.value, t)) ? " selected" : ""}>${ssrInterpolate(typeLabel(t))}</option>`);
			});
			_push(`<!--]--></select></div>`);
			_push(ssrRenderComponent(DataTable_default, {
				columns: txnColumns,
				...
				"cell:type": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="${ssrRenderClass([typeClass(value), "ui-badge"])}" data-v-55e1adb4${_scopeId}>${ssrInterpolate(typeLabel(value))}</span>`);
				...
				"cell:description": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (row.description) _push(`<span data-v-55e1adb4${_scopeId}>${ssrInterpolate(row.description)}</span>`);
						else _push(`<span class="pc__muted" data-v-55e1adb4${_scopeId}>—</span>`);
						if (row.expense_number) _push(`<span class="pc__code" data-v-55e1adb4${_scopeId}>${ssrInterpolate(row.expense_number)}</span>`);
						else if (row.voucher_number) _push(`<span class="pc__code" data-v-55e1adb4${_scopeId}>${ssrInterpolate(row.voucher_number)}</span>`);
						else if (row.reference) _push(`<span class="pc__code" data-v-55e1adb4${_scopeId}>${ssrInterpolate(row.reference)}</span>`);
						else _push(`<!---->`);
				...
				"cell:amount": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<strong class="${ssrRenderClass(Number(value) < 0 ? "pc__out" : "pc__in")}" data-v-55e1adb4${_scopeId}>${ssrInterpolate(signed(value))}</strong>`);
				...
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("petty-cash.delete") && !row.expense_id && !row.expense_voucher_id) _push(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-55e1adb4${_scopeId}>Delete</button>`);
						else if (row.expense_id) _push(`<span class="pc__muted" style="${ssrRenderStyle({ "font-size": "0.78rem" })}" data-v-55e1adb4${_scopeId}>via expense</span>`);
						else if (row.expense_voucher_id) _push(`<span class="pc__muted" style="${ssrRenderStyle({ "font-size": "0.78rem" })}" data-v-55e1adb4${_scopeId}>via voucher</span>`);
						else _push(`<!---->`);
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-55e1adb4${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(accForm).processing) ? " disabled" : ""} data-v-55e1adb4${_scopeId}>Save</button>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="form-grid-2" data-v-55e1adb4${_scopeId}>`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" data-v-55e1adb4${_scopeId}>Current Outlet</option><!--[-->`);
									ssrRenderList(props.branches, (branch) => {
										_push(`<option${ssrRenderAttr("value", branch.id)} data-v-55e1adb4${_scopeId}>${ssrInterpolate(branch.name)}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(`</div><label class="pc__check" data-v-55e1adb4${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(accForm).is_active) ? ssrLooseContain(unref(accForm).is_active, null) : unref(accForm).is_active) ? " checked" : ""} data-v-55e1adb4${_scopeId}><span data-v-55e1adb4${_scopeId}>Active fund</span></label>`);
						if (unref(accForm).id) _push(`<p class="pc__hint" data-v-55e1adb4${_scopeId}>Changing the opening balance re-rolls the running balance across the whole ledger.</p>`);
						else _push(`<!---->`);
						_push(ssrRenderComponent(_sfc_main$2, {
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-55e1adb4${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(txnForm).processing) ? " disabled" : ""} data-v-55e1adb4${_scopeId}>Record</button>`);
					else return [createVNode("button", {
						class: "ui-btn ui-btn--ghost",
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" disabled data-v-55e1adb4${_scopeId}>Select fund</option><!--[-->`);
									ssrRenderList(activeAccounts.value, (a) => {
										_push(`<option${ssrRenderAttr("value", a.id)} data-v-55e1adb4${_scopeId}>${ssrInterpolate(a.name)} (${ssrInterpolate(fmt(a.current_balance))})</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<!--[-->`);
									ssrRenderList(props.types, (t) => {
										_push(`<option${ssrRenderAttr("value", t)} data-v-55e1adb4${_scopeId}>${ssrInterpolate(typeLabel(t))}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(`<p class="pc__hint" data-v-55e1adb4${_scopeId}>${ssrInterpolate(txnHint.value)}</p>`);
					} else return [
						createVNode(_sfc_main$2, {
							modelValue: unref(txnForm).petty_cash_account_id,
							"onUpdate:modelValue": ($event) => unref(txnForm).petty_cash_account_id = $event,
...
var PettyCash_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-55e1adb4"]]);
//#endregion
