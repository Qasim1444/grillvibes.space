...
var _sfc_main = /*@__PURE__*/ Object.assign({ layout: AdminLayout_default }, {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-a1dafb6b>`);
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("expenses.create")) _push(`<button class="ui-btn ui-btn--primary" data-v-a1dafb6b${_scopeId}>+ New Expense</button>`);
						else _push(`<!---->`);
			...
			_push(`<div class="ex__kpis" data-v-a1dafb6b><div class="ex__kpi ex__kpi--warn" data-v-a1dafb6b><span class="ex__kpi-label" data-v-a1dafb6b>Pending</span><span class="ex__kpi-val" data-v-a1dafb6b>${ssrInterpolate(props.summary.pending)}</span><span class="ex__kpi-sub" data-v-a1dafb6b>awaiting approval</span></div><div class="ex__kpi" data-v-a1dafb6b><span class="ex__kpi-label" data-v-a1dafb6b>Pending Amount</span><span class="ex__kpi-val" data-v-a1dafb6b>${ssrInterpolate(fmt(props.summary.pending_amount))}</span><span class="ex__kpi-sub" data-v-a1dafb6b>to be approved</span></div><div class="ex__kpi ex__kpi--ok" data-v-a1dafb6b><span class="ex__kpi-label" data-v-a1dafb6b>Approved (mo.)</span><span class="ex__kpi-val" data-v-a1dafb6b>${ssrInterpolate(fmt(props.summary.approved_this_month))}</span><span class="ex__kpi-sub" data-v-a1dafb6b>this month</span></div><div class="ex__kpi ex__kpi--info" data-v-a1dafb6b><span class="ex__kpi-label" data-v-a1dafb6b>Total (mo.)</span><span class="ex__kpi-val" data-v-a1dafb6b>${ssrInterpolate(fmt(props.summary.total_this_month))}</span><span class="ex__kpi-sub" data-v-a1dafb6b>all expenses this month</span></div></div><div class="ex__filters" data-v-a1dafb6b><input${ssrRenderAttr("value", search.value)} class="ui-input ex__search" placeholder="Search # / description / payee…" data-v-a1dafb6b><select class="ui-input" style="${ssrRenderStyle({ "width": "190px" })}" data-v-a1dafb6b><option value="" data-v-a1dafb6b${ssrIncludeBooleanAttr(Array.isArray(categoryFilter.value) ? ssrLooseContain(categoryFilter.value, "") : ssrLooseEqual(categoryFilter.value, "")) ? " selected" : ""}>All Categories</option><!--[-->`);
			ssrRenderList(props.categories, (c) => {
				_push(`<option${ssrRenderAttr("value", c)} data-v-a1dafb6b${ssrIncludeBooleanAttr(Array.isArray(categoryFilter.value) ? ssrLooseContain(categoryFilter.value, c) : ssrLooseEqual(categoryFilter.value, c)) ? " selected" : ""}>${ssrInterpolate(catLabel(c))}</option>`);
			});
			_push(`<!--]--></select><select class="ui-input" style="${ssrRenderStyle({ "width": "150px" })}" data-v-a1dafb6b><option value="" data-v-a1dafb6b${ssrIncludeBooleanAttr(Array.isArray(statusFilter.value) ? ssrLooseContain(statusFilter.value, "") : ssrLooseEqual(statusFilter.value, "")) ? " selected" : ""}>All Statuses</option><!--[-->`);
			ssrRenderList(props.statuses, (s) => {
				_push(`<option${ssrRenderAttr("value", s)} data-v-a1dafb6b${ssrIncludeBooleanAttr(Array.isArray(statusFilter.value) ? ssrLooseContain(statusFilter.value, s) : ssrLooseEqual(statusFilter.value, s)) ? " selected" : ""}>${ssrInterpolate(statusLabel(s))}</option>`);
			});
			_push(`<!--]--></select><select class="ui-input" style="${ssrRenderStyle({ "width": "160px" })}" data-v-a1dafb6b><option value="" data-v-a1dafb6b${ssrIncludeBooleanAttr(Array.isArray(paidViaFilter.value) ? ssrLooseContain(paidViaFilter.value, "") : ssrLooseEqual(paidViaFilter.value, "")) ? " selected" : ""}>All Payment Methods</option><!--[-->`);
			ssrRenderList(props.paidVia, (p) => {
				_push(`<option${ssrRenderAttr("value", p)} data-v-a1dafb6b${ssrIncludeBooleanAttr(Array.isArray(paidViaFilter.value) ? ssrLooseContain(paidViaFilter.value, p) : ssrLooseEqual(paidViaFilter.value, p)) ? " selected" : ""}>${ssrInterpolate(paidViaLabel(p))}</option>`);
			});
			_push(`<!--]--></select><select class="ui-input" style="${ssrRenderStyle({ "width": "180px" })}" data-v-a1dafb6b><option value="" data-v-a1dafb6b${ssrIncludeBooleanAttr(Array.isArray(branchFilter.value) ? ssrLooseContain(branchFilter.value, "") : ssrLooseEqual(branchFilter.value, "")) ? " selected" : ""}>All Branches</option><!--[-->`);
			ssrRenderList(props.branches, (branch) => {
				_push(`<option${ssrRenderAttr("value", branch.id)} data-v-a1dafb6b${ssrIncludeBooleanAttr(Array.isArray(branchFilter.value) ? ssrLooseContain(branchFilter.value, branch.id) : ssrLooseEqual(branchFilter.value, branch.id)) ? " selected" : ""}>${ssrInterpolate(branch.name)}</option>`);
			});
			_push(`<!--]--></select></div>`);
			_push(ssrRenderComponent(DataTable_default, {
				...
				"cell:category": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="ui-badge ui-badge--muted" data-v-a1dafb6b${_scopeId}>${ssrInterpolate(catLabel(value))}</span>`);
				...
				"cell:payee": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (row.vendor_name || row.payee) _push(`<span data-v-a1dafb6b${_scopeId}>${ssrInterpolate(row.vendor_name || row.payee)}</span>`);
						else _push(`<span class="ex__muted" data-v-a1dafb6b${_scopeId}>—</span>`);
				...
				"cell:amount": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<strong data-v-a1dafb6b${_scopeId}>${ssrInterpolate(fmt(value))}</strong>`);
				...
				"cell:paid_via": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						...
						if (row.account_name) _push(`<span class="ex__code" data-v-a1dafb6b${_scopeId}>${ssrInterpolate(row.account_name)}</span>`);
						else _push(`<!---->`);
				...
				"cell:status": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<span class="${ssrRenderClass([statusClass(row.status), "ui-badge"])}" data-v-a1dafb6b${_scopeId}>${ssrInterpolate(statusLabel(row.status))}</span>`);
						if (row.voucher_number) _push(`<span class="ui-badge ui-badge--info ex__pill"${ssrRenderAttr("title", `Claimed on voucher ${row.voucher_number}`)} data-v-a1dafb6b${_scopeId}> Claimed · ${ssrInterpolate(row.voucher_number)}</span>`);
						else _push(`<!---->`);
				...
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("expenses.approve") && row.status === "pending") _push(`<button class="ui-btn ui-btn--secondary ui-btn--sm" data-v-a1dafb6b${_scopeId}>Approve</button>`);
						else _push(`<!---->`);
						if (unref(can)("expenses.approve") && row.status === "pending") _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-a1dafb6b${_scopeId}>Reject</button>`);
						else _push(`<!---->`);
						if (!row.expense_voucher_id) {
							_push(`<!--[-->`);
							if (unref(can)("expenses.update")) _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-a1dafb6b${_scopeId}>Edit</button>`);
							else _push(`<!---->`);
							if (unref(can)("expenses.delete")) _push(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-a1dafb6b${_scopeId}>Delete</button>`);
							else _push(`<!---->`);
							_push(`<!--]-->`);
						} else _push(`<span class="ex__muted" style="${ssrRenderStyle({ "font-size": "0.78rem" })}" data-v-a1dafb6b${_scopeId}>on voucher</span>`);
					} else return [
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-a1dafb6b${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-a1dafb6b${_scopeId}>Save</button>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<div class="form-grid-2" data-v-a1dafb6b${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<!--[-->`);
									ssrRenderList(props.categories, (c) => {
										_push(`<option${ssrRenderAttr("value", c)} data-v-a1dafb6b${_scopeId}>${ssrInterpolate(catLabel(c))}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" data-v-a1dafb6b${_scopeId}>Current Outlet</option><!--[-->`);
									ssrRenderList(props.branches, (branch) => {
										_push(`<option${ssrRenderAttr("value", branch.id)} data-v-a1dafb6b${_scopeId}>${ssrInterpolate(branch.name)}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<!--[-->`);
									ssrRenderList(props.paidVia, (p) => {
										_push(`<option${ssrRenderAttr("value", p)} data-v-a1dafb6b${_scopeId}>${ssrInterpolate(paidViaLabel(p))}</option>`);
									});
									_push(`<!--]-->`);
						...
						if (unref(form).paid_via === "petty_cash") _push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" disabled data-v-a1dafb6b${_scopeId}>Select fund</option><!--[-->`);
									ssrRenderList(props.accounts, (a) => {
										_push(`<option${ssrRenderAttr("value", a.id)} data-v-a1dafb6b${_scopeId}>${ssrInterpolate(a.name)}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" data-v-a1dafb6b${_scopeId}>— None —</option><!--[-->`);
									ssrRenderList(props.vendors, (v) => {
										_push(`<option${ssrRenderAttr("value", v.id)} data-v-a1dafb6b${_scopeId}>${ssrInterpolate(v.name)}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(`</div>`);
						if (unref(form).paid_via === "petty_cash") _push(`<p class="ex__hint" data-v-a1dafb6b${_scopeId}>Paying from a fund posts a matching disbursement to its petty-cash ledger — unless the expense is claimed on a voucher, in which case the voucher&#39;s combined line covers it instead.</p>`);
						else _push(`<!---->`);
						_push(ssrRenderComponent(_sfc_main$2, {
...
var Expenses_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-a1dafb6b"]]);
//#endregion
