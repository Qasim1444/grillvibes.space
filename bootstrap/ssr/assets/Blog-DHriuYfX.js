...
var _sfc_main = /*@__PURE__*/ Object.assign({ layout: AdminLayout_default }, {
	...
	setup(__props) {
		...
		const deletePost = async (id) => {
			if (await confirmDialog("Are you sure?")) router.delete(`/blog/${id}`, { preserveScroll: true });
		};
		const saveCategory = () => {
		...
		const deleteCategory = async (id) => {
			if (await confirmDialog("Delete this category? Existing posts will be detached.")) router.delete(`/blog/categories/${id}`, { preserveScroll: true });
		};
		const saveTag = () => {
		...
		const deleteTag = async (id) => {
			if (await confirmDialog("Delete this tag? Existing posts will be detached.")) router.delete(`/blog/tags/${id}`, { preserveScroll: true });
		};
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-eef4b681>`);
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("blog.update")) _push(`<button type="button" class="ui-btn ui-btn--ghost" data-v-eef4b681${_scopeId}> Manage Categories &amp; Tags </button>`);
						else _push(`<!---->`);
						if (unref(can)("blog.create")) _push(`<button type="button" class="ui-btn ui-btn--primary" data-v-eef4b681${_scopeId}> + New Post </button>`);
						else _push(`<!---->`);
			...
			_push(ssrRenderComponent(DataTable_default, {
				...
				"cell:status": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="${ssrRenderClass([statusClass(value), "ui-badge"])}" data-v-eef4b681${_scopeId}>${ssrInterpolate(value)}</span>`);
				...
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("blog.update")) _push(`<button type="button" class="ui-btn ui-btn--ghost ui-btn--sm" data-v-eef4b681${_scopeId}> Edit </button>`);
						else _push(`<!---->`);
						if (unref(can)("blog.delete")) _push(`<button type="button" class="ui-btn ui-btn--danger ui-btn--sm" data-v-eef4b681${_scopeId}> Delete </button>`);
						else _push(`<!---->`);
					} else return [unref(can)("blog.update") ? (openBlock(), createBlock("button", {
						key: 0,
						type: "button",
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button type="button" class="ui-btn ui-btn--ghost" data-v-eef4b681${_scopeId}> Cancel </button><button type="button" class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-eef4b681${_scopeId}>${ssrInterpolate(unref(form).processing ? "Saving..." : "Save")}</button>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<div class="editor-field" data-v-eef4b681${_scopeId}><label class="ui-label" data-v-eef4b681${_scopeId}>Body</label><textarea class="blog-body-textarea" placeholder="Write the article..." rows="12" data-v-eef4b681${_scopeId}>${ssrInterpolate(unref(form).body)}</textarea>`);
						if (unref(form).errors.body) _push(`<p class="ui-field__error" data-v-eef4b681${_scopeId}>${ssrInterpolate(unref(form).errors.body)}</p>`);
						else _push(`<!---->`);
						_push(`</div>`);
						_push(ssrRenderComponent(_sfc_main$2, {
						...
						_push(`<div class="blog-form-grid" data-v-eef4b681${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`<option value="draft" data-v-eef4b681${_scopeId}> Draft </option><option value="published" data-v-eef4b681${_scopeId}> Published </option><option value="scheduled" data-v-eef4b681${_scopeId}> Scheduled </option>`);
								else return [
						...
						_push(`</div><p class="blog-form-hint" data-v-eef4b681${_scopeId}> Select one or more categories and tags. Add new options from Manage Categories &amp; Tags. </p>`);
						_push(ssrRenderComponent(_sfc_main$2, {
						...
						_push(`<div class="blog-form-grid" data-v-eef4b681${_scopeId}><div class="multi-select-field" data-v-eef4b681${_scopeId}><label class="ui-label" data-v-eef4b681${_scopeId}> Categories </label><div class="${ssrRenderClass([{ "is-open": categoryDropdownOpen.value }, "multi-select-control"])}" data-v-eef4b681${_scopeId}><div class="multi-select-values" data-v-eef4b681${_scopeId}><!--[-->`);
						ssrRenderList(selectedCategories.value, (category) => {
							_push(`<span class="multi-select-chip" data-v-eef4b681${_scopeId}>${ssrInterpolate(category.name)} <button type="button" class="multi-select-chip-remove" data-v-eef4b681${_scopeId}> × </button></span>`);
						});
						_push(`<!--]-->`);
						if (unref(form).category_ids.length === 0) _push(`<span class="multi-select-placeholder" data-v-eef4b681${_scopeId}> Select categories </span>`);
						else _push(`<!---->`);
						_push(`</div><span class="multi-select-arrow" data-v-eef4b681${_scopeId}>${ssrInterpolate(categoryDropdownOpen.value ? "▲" : "▼")}</span></div>`);
						if (categoryDropdownOpen.value) {
							_push(`<div class="multi-select-dropdown" data-v-eef4b681${_scopeId}><div class="multi-select-search-box" data-v-eef4b681${_scopeId}><input${ssrRenderAttr("value", categorySearch.value)} type="text" class="multi-select-search" placeholder="Search categories..." data-v-eef4b681${_scopeId}></div>`);
							if (filteredCategories.value.length) _push(`<div class="multi-select-select-all" data-v-eef4b681${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(allCategoriesSelected.value) ? " checked" : ""} data-v-eef4b681${_scopeId}><span data-v-eef4b681${_scopeId}>${ssrInterpolate(allCategoriesSelected.value ? "Deselect all" : "Select all")}</span></div>`);
							else _push(`<!---->`);
							_push(`<div class="multi-select-options" data-v-eef4b681${_scopeId}><!--[-->`);
							ssrRenderList(filteredCategories.value, (category) => {
								_push(`<label class="${ssrRenderClass([{ selected: isCategorySelected(category.id) }, "multi-select-option"])}" data-v-eef4b681${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(isCategorySelected(category.id)) ? " checked" : ""} data-v-eef4b681${_scopeId}><span data-v-eef4b681${_scopeId}>${ssrInterpolate(category.name)}</span></label>`);
							});
							_push(`<!--]-->`);
							if (filteredCategories.value.length === 0) _push(`<div class="multi-select-empty" data-v-eef4b681${_scopeId}> No categories found. </div>`);
							else _push(`<!---->`);
							_push(`</div></div>`);
						} else _push(`<!---->`);
						if (unref(form).errors.category_ids) _push(`<p class="ui-field__error" data-v-eef4b681${_scopeId}>${ssrInterpolate(unref(form).errors.category_ids)}</p>`);
						else _push(`<!---->`);
						_push(`</div><div class="multi-select-field" data-v-eef4b681${_scopeId}><label class="ui-label" data-v-eef4b681${_scopeId}> Tags </label><div class="${ssrRenderClass([{ "is-open": tagDropdownOpen.value }, "multi-select-control"])}" data-v-eef4b681${_scopeId}><div class="multi-select-values" data-v-eef4b681${_scopeId}><!--[-->`);
						ssrRenderList(selectedTags.value, (tag) => {
							_push(`<span class="multi-select-chip" data-v-eef4b681${_scopeId}>${ssrInterpolate(tag.name)} <button type="button" class="multi-select-chip-remove" data-v-eef4b681${_scopeId}> × </button></span>`);
						});
						_push(`<!--]-->`);
						if (unref(form).tag_ids.length === 0) _push(`<span class="multi-select-placeholder" data-v-eef4b681${_scopeId}> Select tags </span>`);
						else _push(`<!---->`);
						_push(`</div><span class="multi-select-arrow" data-v-eef4b681${_scopeId}>${ssrInterpolate(tagDropdownOpen.value ? "▲" : "▼")}</span></div>`);
						if (tagDropdownOpen.value) {
							_push(`<div class="multi-select-dropdown" data-v-eef4b681${_scopeId}><div class="multi-select-search-box" data-v-eef4b681${_scopeId}><input${ssrRenderAttr("value", tagSearch.value)} type="text" class="multi-select-search" placeholder="Search tags..." data-v-eef4b681${_scopeId}></div>`);
							if (filteredTags.value.length) _push(`<div class="multi-select-select-all" data-v-eef4b681${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(allTagsSelected.value) ? " checked" : ""} data-v-eef4b681${_scopeId}><span data-v-eef4b681${_scopeId}>${ssrInterpolate(allTagsSelected.value ? "Deselect all" : "Select all")}</span></div>`);
							else _push(`<!---->`);
							_push(`<div class="multi-select-options" data-v-eef4b681${_scopeId}><!--[-->`);
							ssrRenderList(filteredTags.value, (tag) => {
								_push(`<label class="${ssrRenderClass([{ selected: isTagSelected(tag.id) }, "multi-select-option"])}" data-v-eef4b681${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(isTagSelected(tag.id)) ? " checked" : ""} data-v-eef4b681${_scopeId}><span data-v-eef4b681${_scopeId}>${ssrInterpolate(tag.name)}</span></label>`);
							});
							_push(`<!--]-->`);
							if (filteredTags.value.length === 0) _push(`<div class="multi-select-empty" data-v-eef4b681${_scopeId}> No tags found. </div>`);
							else _push(`<!---->`);
							_push(`</div></div>`);
						} else _push(`<!---->`);
						if (unref(form).errors.tag_ids) _push(`<p class="ui-field__error" data-v-eef4b681${_scopeId}>${ssrInterpolate(unref(form).errors.tag_ids)}</p>`);
						else _push(`<!---->`);
						_push(`</div></div>`);
					} else return [
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="taxonomy-grid" data-v-eef4b681${_scopeId}><section data-v-eef4b681${_scopeId}><h3 data-v-eef4b681${_scopeId}> Categories </h3><form class="taxonomy-add" data-v-eef4b681${_scopeId}><input${ssrRenderAttr("value", unref(categoryForm).name)} class="ui-input" placeholder="New category name" data-v-eef4b681${_scopeId}><button type="submit" class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(categoryForm).processing) ? " disabled" : ""} data-v-eef4b681${_scopeId}>${ssrInterpolate(unref(categoryForm).processing ? "Adding..." : "Add")}</button></form>`);
						if (unref(categoryForm).errors.name) _push(`<p class="ui-field__error" data-v-eef4b681${_scopeId}>${ssrInterpolate(unref(categoryForm).errors.name)}</p>`);
						else _push(`<!---->`);
						_push(`<!--[-->`);
						ssrRenderList(props.categories, (category) => {
							_push(`<div class="taxonomy-row" data-v-eef4b681${_scopeId}><input${ssrRenderAttr("value", categoryEdits.value[category.id])} class="ui-input" data-v-eef4b681${_scopeId}><button type="button" class="ui-btn ui-btn--ghost ui-btn--sm" data-v-eef4b681${_scopeId}> Save </button><button type="button" class="ui-btn ui-btn--danger ui-btn--sm" data-v-eef4b681${_scopeId}> Delete </button></div>`);
						});
						_push(`<!--]--></section><section data-v-eef4b681${_scopeId}><h3 data-v-eef4b681${_scopeId}> Tags </h3><form class="taxonomy-add" data-v-eef4b681${_scopeId}><input${ssrRenderAttr("value", unref(tagForm).name)} class="ui-input" placeholder="New tag name" data-v-eef4b681${_scopeId}><button type="submit" class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(tagForm).processing) ? " disabled" : ""} data-v-eef4b681${_scopeId}>${ssrInterpolate(unref(tagForm).processing ? "Adding..." : "Add")}</button></form>`);
						if (unref(tagForm).errors.name) _push(`<p class="ui-field__error" data-v-eef4b681${_scopeId}>${ssrInterpolate(unref(tagForm).errors.name)}</p>`);
						else _push(`<!---->`);
						_push(`<!--[-->`);
						ssrRenderList(props.tags, (tag) => {
							_push(`<div class="taxonomy-row" data-v-eef4b681${_scopeId}><input${ssrRenderAttr("value", tagEdits.value[tag.id])} class="ui-input" data-v-eef4b681${_scopeId}><button type="button" class="ui-btn ui-btn--ghost ui-btn--sm" data-v-eef4b681${_scopeId}> Save </button><button type="button" class="ui-btn ui-btn--danger ui-btn--sm" data-v-eef4b681${_scopeId}> Delete </button></div>`);
						});
						_push(`<!--]--></section></div>`);
...
var Blog_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-eef4b681"]]);
//#endregion
