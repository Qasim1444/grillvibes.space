...
var _sfc_main = /*@__PURE__*/ Object.assign({ layout: AdminLayout_default }, {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-bfc1de83>`);
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						if (unref(can)("procurement.purchase-orders.create")) _push(`<button class="ui-btn ui-btn--primary" data-v-bfc1de83${_scopeId}> + New Purchase Order </button>`);
						else _push(`<!---->`);
			...
			_push(`<div class="po__kpis" data-v-bfc1de83><div class="po__kpi po__kpi--muted" data-v-bfc1de83><span class="po__kpi-label" data-v-bfc1de83>Drafts</span><span class="po__kpi-val" data-v-bfc1de83>${ssrInterpolate(props.summary.draft)}</span><span class="po__kpi-sub" data-v-bfc1de83>not yet sent to a vendor</span></div><div class="po__kpi po__kpi--info" data-v-bfc1de83><span class="po__kpi-label" data-v-bfc1de83>Awaiting Delivery</span><span class="po__kpi-val" data-v-bfc1de83>${ssrInterpolate(props.summary.open)}</span><span class="po__kpi-sub" data-v-bfc1de83>${ssrInterpolate(fmt(props.summary.open_value))} committed</span></div><div class="${ssrRenderClass([props.summary.overdue > 0 ? "po__kpi--danger" : "po__kpi--ok", "po__kpi"])}" data-v-bfc1de83><span class="po__kpi-label" data-v-bfc1de83>Overdue</span><span class="po__kpi-val" data-v-bfc1de83>${ssrInterpolate(props.summary.overdue)}</span><span class="po__kpi-sub" data-v-bfc1de83>past their expected date</span></div><div class="po__kpi po__kpi--ok" data-v-bfc1de83><span class="po__kpi-label" data-v-bfc1de83>Completed This Month</span><span class="po__kpi-val" data-v-bfc1de83>${ssrInterpolate(props.summary.received_this_month)}</span><span class="po__kpi-sub" data-v-bfc1de83>fully received</span></div></div><div class="po__filters" data-v-bfc1de83><input${ssrRenderAttr("value", search.value)} class="ui-input po__search" placeholder="Search PO number / vendor…" data-v-bfc1de83><select class="ui-input" style="${ssrRenderStyle({ "width": "190px" })}" data-v-bfc1de83><option value="" data-v-bfc1de83${ssrIncludeBooleanAttr(Array.isArray(statusFilter.value) ? ssrLooseContain(statusFilter.value, "") : ssrLooseEqual(statusFilter.value, "")) ? " selected" : ""}>All Statuses</option><!--[-->`);
			ssrRenderList(props.statuses, (label, value) => {
				_push(`<option${ssrRenderAttr("value", value)} data-v-bfc1de83${ssrIncludeBooleanAttr(Array.isArray(statusFilter.value) ? ssrLooseContain(statusFilter.value, value) : ssrLooseEqual(statusFilter.value, value)) ? " selected" : ""}>${ssrInterpolate(label)}</option>`);
			});
			_push(`<!--]--></select><select class="ui-input" style="${ssrRenderStyle({ "width": "210px" })}" data-v-bfc1de83><option value="" data-v-bfc1de83${ssrIncludeBooleanAttr(Array.isArray(vendorFilter.value) ? ssrLooseContain(vendorFilter.value, "") : ssrLooseEqual(vendorFilter.value, "")) ? " selected" : ""}>All Vendors</option><!--[-->`);
			ssrRenderList(props.vendors, (v) => {
				_push(`<option${ssrRenderAttr("value", v.id)} data-v-bfc1de83${ssrIncludeBooleanAttr(Array.isArray(vendorFilter.value) ? ssrLooseContain(vendorFilter.value, v.id) : ssrLooseEqual(vendorFilter.value, v.id)) ? " selected" : ""}>${ssrInterpolate(v.name)}</option>`);
			});
			_push(`<!--]--></select></div>`);
			_push(ssrRenderComponent(DataTable_default, {
				...
				"cell:po_number": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) _push(`<strong data-v-bfc1de83${_scopeId}>${ssrInterpolate(row.po_number)}</strong><span class="po__sub" data-v-bfc1de83${_scopeId}>${ssrInterpolate(row.line_count)} line(s)</span>`);
				...
				"cell:vendor_name": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						...
						if (row.created_by_name) _push(`<span class="po__sub" data-v-bfc1de83${_scopeId}>by ${ssrInterpolate(row.created_by_name)}</span>`);
						else _push(`<!---->`);
				...
				"cell:status": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<span class="${ssrRenderClass([statusBadge(row.status), "ui-badge"])}" data-v-bfc1de83${_scopeId}>${ssrInterpolate(row.status_label)}</span>`);
						if (row.is_overdue) _push(`<span class="ui-badge ui-badge--danger po__pill" data-v-bfc1de83${_scopeId}>Overdue</span>`);
						else _push(`<!---->`);
				...
				"cell:expected_at": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<span class="${ssrRenderClass(row.is_overdue ? "po__neg" : "")}" data-v-bfc1de83${_scopeId}>${ssrInterpolate(fmtDate(row.expected_at))}</span>`);
						if (row.ordered_at) _push(`<span class="po__sub" data-v-bfc1de83${_scopeId}>sent ${ssrInterpolate(fmtDate(row.ordered_at))}</span>`);
						else _push(`<!---->`);
				...
				"cell:total": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<strong data-v-bfc1de83${_scopeId}>${ssrInterpolate(fmt(value))}</strong>`);
					else return [createVNode("strong", null, toDisplayString(fmt(value)), 1)];
				}),
				"cell:outstanding_value": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (row.outstanding_value > 0) _push(`<span class="po__warn" data-v-bfc1de83${_scopeId}>${ssrInterpolate(fmt(row.outstanding_value))}</span>`);
						else _push(`<span class="po__muted" data-v-bfc1de83${_scopeId}>—</span>`);
				...
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-bfc1de83${_scopeId}>View</button>`);
						if (row.is_draft && unref(can)("procurement.purchase-orders.update")) _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-bfc1de83${_scopeId}>Edit</button>`);
						else _push(`<!---->`);
						if (row.is_draft && unref(can)("procurement.purchase-orders.approve")) _push(`<button class="ui-btn ui-btn--primary ui-btn--sm" data-v-bfc1de83${_scopeId}>Send</button>`);
						else _push(`<!---->`);
						...
						if (!row.is_draft && row.is_receivable && unref(can)("procurement.purchase-orders.update")) _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-bfc1de83${_scopeId}>Cancel</button>`);
						else _push(`<!---->`);
						if (row.is_draft && unref(can)("procurement.purchase-orders.delete")) _push(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-bfc1de83${_scopeId}>Delete</button>`);
						else _push(`<!---->`);
					} else return [
						createVNode("button", {
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-bfc1de83${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(form).processing || hasDuplicates.value || !validLines.value.length) ? " disabled" : ""} data-v-bfc1de83${_scopeId}>${ssrInterpolate(unref(form).id ? "Save Changes" : "Save Draft")}</button>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="form-grid-2" data-v-bfc1de83${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" data-v-bfc1de83${_scopeId}>Select a vendor…</option><!--[-->`);
									ssrRenderList(props.vendors, (v) => {
										_push(`<option${ssrRenderAttr("value", v.id)} data-v-bfc1de83${_scopeId}>${ssrInterpolate(v.name)}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(`</div>`);
						if (selectedVendorTerms.value) _push(`<p class="po__terms" data-v-bfc1de83${_scopeId}>Payment terms: ${ssrInterpolate(selectedVendorTerms.value)}</p>`);
						else _push(`<!---->`);
						_push(`<table class="po__table" data-v-bfc1de83${_scopeId}><thead data-v-bfc1de83${_scopeId}><tr data-v-bfc1de83${_scopeId}><th style="${ssrRenderStyle({ "width": "36%" })}" data-v-bfc1de83${_scopeId}>Ingredient</th><th style="${ssrRenderStyle({ "width": "18%" })}" data-v-bfc1de83${_scopeId}>Quantity</th><th style="${ssrRenderStyle({ "width": "18%" })}" data-v-bfc1de83${_scopeId}>Unit Cost</th><th class="po__right" data-v-bfc1de83${_scopeId}>Line Total</th><th style="${ssrRenderStyle({ "width": "40px" })}" data-v-bfc1de83${_scopeId}></th></tr></thead><tbody data-v-bfc1de83${_scopeId}>`);
						if (!unref(form).lines.length) _push(`<tr data-v-bfc1de83${_scopeId}><td colspan="5" class="po__muted po__empty" data-v-bfc1de83${_scopeId}>Add the first line to start this order.</td></tr>`);
						else _push(`<!---->`);
						_push(`<!--[-->`);
						ssrRenderList(unref(form).lines, (line, i) => {
							_push(`<tr data-v-bfc1de83${_scopeId}><td data-v-bfc1de83${_scopeId}><select class="ui-input" data-v-bfc1de83${_scopeId}><option value="" data-v-bfc1de83${ssrIncludeBooleanAttr(Array.isArray(line.ingredient_id) ? ssrLooseContain(line.ingredient_id, "") : ssrLooseEqual(line.ingredient_id, "")) ? " selected" : ""}${_scopeId}>Select…</option><!--[-->`);
							ssrRenderList(props.ingredients, (ing) => {
								_push(`<option${ssrRenderAttr("value", ing.id)} data-v-bfc1de83${ssrIncludeBooleanAttr(Array.isArray(line.ingredient_id) ? ssrLooseContain(line.ingredient_id, ing.id) : ssrLooseEqual(line.ingredient_id, ing.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(ing.name)}</option>`);
							});
							_push(`<!--]--></select>`);
							if (isDuplicate(line, i)) _push(`<span class="po__err" data-v-bfc1de83${_scopeId}>Already listed above</span>`);
							else _push(`<!---->`);
							_push(`</td><td data-v-bfc1de83${_scopeId}><div class="po__qty" data-v-bfc1de83${_scopeId}><input${ssrRenderAttr("value", line.quantity)} type="number" step="0.0001" min="0" class="ui-input" data-v-bfc1de83${_scopeId}><span class="po__unit" data-v-bfc1de83${_scopeId}>${ssrInterpolate(unitOf(line.ingredient_id))}</span></div></td><td data-v-bfc1de83${_scopeId}><input${ssrRenderAttr("value", line.unit_cost)} type="number" step="0.01" min="0" class="ui-input" data-v-bfc1de83${_scopeId}></td><td class="po__right" data-v-bfc1de83${_scopeId}><strong data-v-bfc1de83${_scopeId}>${ssrInterpolate(fmt(lineTotal(line)))}</strong></td><td data-v-bfc1de83${_scopeId}><button class="ui-btn ui-btn--danger ui-btn--sm" title="Remove line" data-v-bfc1de83${_scopeId}>×</button></td></tr>`);
						});
						_push(`<!--]--></tbody>`);
						if (unref(form).lines.length) _push(`<tfoot data-v-bfc1de83${_scopeId}><tr data-v-bfc1de83${_scopeId}><td colspan="3" class="po__right" data-v-bfc1de83${_scopeId}><strong data-v-bfc1de83${_scopeId}>Order Total</strong></td><td class="po__right" data-v-bfc1de83${_scopeId}><strong data-v-bfc1de83${_scopeId}>${ssrInterpolate(fmt(orderTotal.value))}</strong></td><td data-v-bfc1de83${_scopeId}></td></tr></tfoot>`);
						else _push(`<!---->`);
						_push(`</table>`);
						if (unref(form).errors.lines) _push(`<p class="po__err" data-v-bfc1de83${_scopeId}>${ssrInterpolate(unref(form).errors.lines)}</p>`);
						else _push(`<!---->`);
						_push(`<button class="ui-btn ui-btn--secondary ui-btn--sm po__add" data-v-bfc1de83${_scopeId}>+ Add Line</button>`);
						_push(ssrRenderComponent(_sfc_main$2, {
						...
						_push(`<p class="po__hint" data-v-bfc1de83${_scopeId}> Saved as a draft — it commits nothing until you send it. Unit costs here are what you expect to pay; the price that actually values your stock is the one on the delivery invoice. </p>`);
					} else return [
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<button class="ui-btn ui-btn--ghost" data-v-bfc1de83${_scopeId}>Close</button>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (viewing.value) {
							_push(`<div data-v-bfc1de83${_scopeId}><div class="po__meta" data-v-bfc1de83${_scopeId}><div data-v-bfc1de83${_scopeId}><span class="po__meta-label" data-v-bfc1de83${_scopeId}>Vendor</span><span data-v-bfc1de83${_scopeId}>${ssrInterpolate(viewing.value.vendor_name || "—")}</span></div><div data-v-bfc1de83${_scopeId}><span class="po__meta-label" data-v-bfc1de83${_scopeId}>Status</span><span class="${ssrRenderClass([statusBadge(viewing.value.status), "ui-badge"])}" data-v-bfc1de83${_scopeId}>${ssrInterpolate(viewing.value.status_label)}</span></div><div data-v-bfc1de83${_scopeId}><span class="po__meta-label" data-v-bfc1de83${_scopeId}>Sent</span><span data-v-bfc1de83${_scopeId}>${ssrInterpolate(fmtDate(viewing.value.ordered_at))}</span></div><div data-v-bfc1de83${_scopeId}><span class="po__meta-label" data-v-bfc1de83${_scopeId}>Expected</span><span class="${ssrRenderClass(viewing.value.is_overdue ? "po__neg" : "")}" data-v-bfc1de83${_scopeId}>${ssrInterpolate(fmtDate(viewing.value.expected_at))}</span></div><div data-v-bfc1de83${_scopeId}><span class="po__meta-label" data-v-bfc1de83${_scopeId}>Total</span><span data-v-bfc1de83${_scopeId}><strong data-v-bfc1de83${_scopeId}>${ssrInterpolate(fmt(viewing.value.total))}</strong></span></div><div data-v-bfc1de83${_scopeId}><span class="po__meta-label" data-v-bfc1de83${_scopeId}>Outstanding</span><span class="${ssrRenderClass(viewing.value.outstanding_value > 0 ? "po__warn" : "")}" data-v-bfc1de83${_scopeId}>${ssrInterpolate(fmt(viewing.value.outstanding_value))}</span></div></div><table class="po__table" data-v-bfc1de83${_scopeId}><thead data-v-bfc1de83${_scopeId}><tr data-v-bfc1de83${_scopeId}><th data-v-bfc1de83${_scopeId}>Ingredient</th><th class="po__right" data-v-bfc1de83${_scopeId}>Ordered</th><th class="po__right" data-v-bfc1de83${_scopeId}>Received</th><th class="po__right" data-v-bfc1de83${_scopeId}>Outstanding</th><th class="po__right" data-v-bfc1de83${_scopeId}>Unit Cost</th><th class="po__right" data-v-bfc1de83${_scopeId}>Line Total</th></tr></thead><tbody data-v-bfc1de83${_scopeId}><!--[-->`);
							ssrRenderList(viewing.value.lines, (line) => {
								_push(`<tr data-v-bfc1de83${_scopeId}><td data-v-bfc1de83${_scopeId}>${ssrInterpolate(line.name)}</td><td class="po__right" data-v-bfc1de83${_scopeId}>${ssrInterpolate(qty(line.quantity))} ${ssrInterpolate(line.unit)}</td><td class="po__right" data-v-bfc1de83${_scopeId}>${ssrInterpolate(qty(line.received_qty))}</td><td class="${ssrRenderClass([line.outstanding_qty > 0 ? "po__warn" : "po__muted", "po__right"])}" data-v-bfc1de83${_scopeId}>${ssrInterpolate(qty(line.outstanding_qty))}</td><td class="po__right po__muted" data-v-bfc1de83${_scopeId}>${ssrInterpolate(fmt(line.unit_cost))}</td><td class="po__right" data-v-bfc1de83${_scopeId}><strong data-v-bfc1de83${_scopeId}>${ssrInterpolate(fmt(line.line_total))}</strong></td></tr>`);
							});
							_push(`<!--]--></tbody></table>`);
							if (viewing.value.notes) _push(`<p class="po__notes" data-v-bfc1de83${_scopeId}><span class="po__meta-label" data-v-bfc1de83${_scopeId}>Notes</span>${ssrInterpolate(viewing.value.notes)}</p>`);
							else _push(`<!---->`);
							_push(`</div>`);
						} else _push(`<!---->`);
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-bfc1de83${_scopeId}>Keep Open</button><button class="ui-btn ui-btn--danger"${ssrIncludeBooleanAttr(unref(cancelForm).processing) ? " disabled" : ""} data-v-bfc1de83${_scopeId}>Cancel Order</button>`);
					else return [createVNode("button", {
						class: "ui-btn ui-btn--ghost",
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<p class="po__hint" data-v-bfc1de83${_scopeId}> Cancelling abandons whatever is still outstanding on ${ssrInterpolate(cancelling.value?.po_number)}. Anything already delivered keeps its stock and its cost — this only closes the order. </p>`);
						_push(ssrRenderComponent(_sfc_main$2, {
...
var PurchaseOrders_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-bfc1de83"]]);
//#endregion
