...
var _sfc_main = /*@__PURE__*/ Object.assign({ layout: AdminLayout_default }, {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-57e71f9a>`);
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("hr.loans.create")) _push(`<button class="ui-btn ui-btn--primary" data-v-57e71f9a${_scopeId}>+ Add Loan</button>`);
						else _push(`<!---->`);
			...
			if (flashError.value) _push(`<div class="ui-alert ui-alert--danger" data-v-57e71f9a>${ssrInterpolate(flashError.value)}</div>`);
			else _push(`<!---->`);
			_push(`<div class="stat-grid" data-v-57e71f9a>`);
			...
			_push(`</div><div class="ln__filters" data-v-57e71f9a>`);
			_push(ssrRenderComponent(_sfc_main$2, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<option value="" data-v-57e71f9a${_scopeId}>All statuses</option><option value="active" data-v-57e71f9a${_scopeId}>Active</option><option value="closed" data-v-57e71f9a${_scopeId}>Closed</option>`);
					else return [
			...
			_push(ssrRenderComponent(DataTable_default, {
				...
				"cell:employee_name": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="ln__name" data-v-57e71f9a${_scopeId}><strong data-v-57e71f9a${_scopeId}>${ssrInterpolate(row.employee_name)}</strong>`);
						if (row.employee_code) _push(`<span class="ln__code" data-v-57e71f9a${_scopeId}>${ssrInterpolate(row.employee_code)}</span>`);
						else _push(`<!---->`);
						_push(`</div>`);
				...
				"cell:type": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="${ssrRenderClass([value === "advance" ? "ui-badge--info" : "ui-badge--muted", "ui-badge"])}" data-v-57e71f9a${_scopeId}>${ssrInterpolate(label(value))}</span>`);
				...
				"cell:recovered": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) _push(`<div class="ln__progress" data-v-57e71f9a${_scopeId}><span data-v-57e71f9a${_scopeId}>${ssrInterpolate(money(row.recovered))}</span><div class="ln__bar" data-v-57e71f9a${_scopeId}><span style="${ssrRenderStyle({ width: percent(row) + "%" })}" data-v-57e71f9a${_scopeId}></span></div></div>`);
				...
				"cell:outstanding": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<strong data-v-57e71f9a${_scopeId}>${ssrInterpolate(money(value))}</strong>`);
					else return [createVNode("strong", null, toDisplayString(money(value)), 1)];
				}),
				"cell:status": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="${ssrRenderClass([value === "active" ? "ui-badge--warning" : "ui-badge--success", "ui-badge"])}" data-v-57e71f9a${_scopeId}>${ssrInterpolate(label(value))}</span>`);
				...
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-57e71f9a${_scopeId}> History (${ssrInterpolate(row.repayments.length)}) </button>`);
						if (unref(can)("hr.loans.update") && row.status === "active") _push(`<button class="ui-btn ui-btn--success ui-btn--sm" data-v-57e71f9a${_scopeId}> Repay </button>`);
						else _push(`<!---->`);
						if (unref(can)("hr.loans.update")) _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-57e71f9a${_scopeId}> Edit </button>`);
						else _push(`<!---->`);
						if (unref(can)("hr.loans.delete") && !row.repayments.length) _push(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-57e71f9a${_scopeId}> Delete </button>`);
						else _push(`<!---->`);
					} else return [
						createVNode("button", {
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-57e71f9a${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-57e71f9a${_scopeId}>Save</button>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" data-v-57e71f9a${_scopeId}>— select —</option><!--[-->`);
									ssrRenderList(props.employees, (e) => {
										_push(`<option${ssrRenderAttr("value", e.id)} data-v-57e71f9a${_scopeId}>${ssrInterpolate(e.name)}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(`<div class="ln__grid" data-v-57e71f9a${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`<option value="loan" data-v-57e71f9a${_scopeId}>Loan</option><option value="advance" data-v-57e71f9a${_scopeId}>Salary advance</option>`);
						...
						_push(`</div>`);
						if (months.value) _push(`<p class="ln__hint" data-v-57e71f9a${_scopeId}>Recovers in about ${ssrInterpolate(months.value)} month${ssrInterpolate(months.value === 1 ? "" : "s")}.</p>`);
						else _push(`<!---->`);
						_push(ssrRenderComponent(_sfc_main$2, {
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-57e71f9a${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(repayForm).processing) ? " disabled" : ""} data-v-57e71f9a${_scopeId}>Save</button>`);
					else return [createVNode("button", {
						class: "ui-btn ui-btn--ghost",
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<p class="ln__hint" data-v-57e71f9a${_scopeId}>${ssrInterpolate(active.value?.employee_name)} — outstanding <strong data-v-57e71f9a${_scopeId}>${ssrInterpolate(money(active.value?.outstanding))}</strong></p><div class="ln__grid" data-v-57e71f9a${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$2, {
						...
						_push(`</div><p class="ln__note" data-v-57e71f9a${_scopeId}> Use this only for repayments taken outside payroll — payroll collects the installment itself when a run is marked paid. </p>`);
					} else return [
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-57e71f9a${_scopeId}>Close</button>`);
					else return [createVNode("button", {
						class: "ui-btn ui-btn--ghost",
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<p class="ln__hint" data-v-57e71f9a${_scopeId}>${ssrInterpolate(active.value?.employee_name)} — ${ssrInterpolate(money(active.value?.recovered))} of ${ssrInterpolate(money(active.value?.amount))} recovered </p>`);
						if (active.value?.repayments?.length) {
							_push(`<table class="ln__table" data-v-57e71f9a${_scopeId}><thead data-v-57e71f9a${_scopeId}><tr data-v-57e71f9a${_scopeId}><th data-v-57e71f9a${_scopeId}>Paid on</th><th data-v-57e71f9a${_scopeId}>Amount</th><th data-v-57e71f9a${_scopeId}>Source</th></tr></thead><tbody data-v-57e71f9a${_scopeId}><!--[-->`);
							ssrRenderList(active.value.repayments, (r) => {
								_push(`<tr data-v-57e71f9a${_scopeId}><td data-v-57e71f9a${_scopeId}>${ssrInterpolate(r.paid_on)}</td><td data-v-57e71f9a${_scopeId}>${ssrInterpolate(money(r.amount))}</td><td data-v-57e71f9a${_scopeId}>${ssrInterpolate(r.payroll_run_id ? `Payroll run #${r.payroll_run_id}` : "Manual")}</td></tr>`);
							});
							_push(`<!--]--></tbody></table>`);
						} else _push(`<p class="ln__note" data-v-57e71f9a${_scopeId}>No repayments yet.</p>`);
...
var Loans_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-57e71f9a"]]);
//#endregion
