...
var _sfc_main = /*@__PURE__*/ Object.assign({ layout: AdminLayout_default }, {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-8149b33d>`);
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("users.create")) _push(`<button class="ui-btn ui-btn--primary" data-v-8149b33d${_scopeId}>+ Add User</button>`);
						else _push(`<!---->`);
			...
			_push(ssrRenderComponent(DataTable_default, {
				...
				"cell:role_names": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) {
						if (value) _push(`<span class="ui-badge ui-badge--success" data-v-8149b33d${_scopeId}>${ssrInterpolate(value)}</span>`);
						else _push(`<span class="ui-badge ui-badge--muted" data-v-8149b33d${_scopeId}>No role</span>`);
				...
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("users.update")) _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-8149b33d${_scopeId}>Edit</button>`);
						else _push(`<!---->`);
						if (unref(can)("users.update")) _push(`<button class="ui-btn ui-btn--secondary ui-btn--sm" data-v-8149b33d${_scopeId}>Assign Role</button>`);
						else _push(`<!---->`);
						if (unref(can)("users.delete")) _push(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-8149b33d${_scopeId}>Delete</button>`);
						else _push(`<!---->`);
					} else return [
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-8149b33d${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-8149b33d${_scopeId}>Save</button>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (errorMsg.value) _push(`<div class="ui-alert ui-alert--danger" data-v-8149b33d${_scopeId}>${ssrInterpolate(errorMsg.value)}</div>`);
						else _push(`<!---->`);
						...
						_push(`<div class="ui-field" data-v-8149b33d${_scopeId}><label class="ui-label" data-v-8149b33d${_scopeId}>Roles</label><div class="users__roles" data-v-8149b33d${_scopeId}><!--[-->`);
						ssrRenderList(props.roles, (r) => {
							_push(`<label class="users__role" data-v-8149b33d${_scopeId}><input type="checkbox"${ssrRenderAttr("value", r.id)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).role_ids) ? ssrLooseContain(unref(form).role_ids, r.id) : unref(form).role_ids) ? " checked" : ""} data-v-8149b33d${_scopeId}><span data-v-8149b33d${_scopeId}>${ssrInterpolate(r.name)}</span></label>`);
						});
						_push(`<!--]-->`);
						if (!props.roles.length) _push(`<p class="users__roles-empty" data-v-8149b33d${_scopeId}> No roles defined yet — create one on the Roles &amp; Permissions page. </p>`);
						else _push(`<!---->`);
						_push(`</div>`);
						if (unref(form).errors.role_ids) _push(`<span class="ui-field__error" data-v-8149b33d${_scopeId}>${ssrInterpolate(unref(form).errors.role_ids)}</span>`);
						else _push(`<!---->`);
						_push(`</div>`);
					} else return [
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-8149b33d${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(assignForm).processing) ? " disabled" : ""} data-v-8149b33d${_scopeId}>Save</button>`);
					else return [createVNode("button", {
						class: "ui-btn ui-btn--ghost",
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<p class="assign-role__name" data-v-8149b33d${_scopeId}>User: <strong data-v-8149b33d${_scopeId}>${ssrInterpolate(unref(assignForm).userName)}</strong></p><div class="ui-field" data-v-8149b33d${_scopeId}><label class="ui-label" data-v-8149b33d${_scopeId}>Roles</label><div class="users__roles" data-v-8149b33d${_scopeId}><!--[-->`);
						ssrRenderList(props.roles, (r) => {
							_push(`<label class="users__role" data-v-8149b33d${_scopeId}><input type="checkbox"${ssrRenderAttr("value", r.id)}${ssrIncludeBooleanAttr(Array.isArray(unref(assignForm).role_ids) ? ssrLooseContain(unref(assignForm).role_ids, r.id) : unref(assignForm).role_ids) ? " checked" : ""} data-v-8149b33d${_scopeId}><span data-v-8149b33d${_scopeId}>${ssrInterpolate(r.name)}</span></label>`);
						});
						_push(`<!--]-->`);
						if (!props.roles.length) _push(`<p class="users__roles-empty" data-v-8149b33d${_scopeId}> No roles defined yet — create one on the Roles &amp; Permissions page. </p>`);
						else _push(`<!---->`);
						_push(`</div>`);
						if (unref(assignForm).errors.role_ids) _push(`<span class="ui-field__error" data-v-8149b33d${_scopeId}>${ssrInterpolate(unref(assignForm).errors.role_ids)}</span>`);
						else _push(`<!---->`);
						_push(`</div>`);
...
var Users_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-8149b33d"]]);
//#endregion
